...
const FloatsButtons = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        const data = {
            full_name: formRef.current.full_name.value, // Access the full_name field
            email: formRef.current.email.value, // Access the email field
            phone: formRef.current.phone.value, // Access the phone field
            location: formRef.current.location.value, // Access the location field
            course: formRef.current.course.value, // Access the course field
            referral: formRef.current.referral.value, // Access the referral field
            background: formRef.current.background.value, // Access the background field
        };
                ...
                <div className="fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center z-[100] px-4 sm:px-6 py-6 overflow-y-auto">
                    <div className="bg-[#1e4272] text-white w-full max-w-[95%] sm:max-w-2xl p-4 sm:p-8 rounded-lg shadow-lg relative z-[101] max-h-[90vh] overflow-y-auto">
                        ...
                        <div className="mt-6 space-y-2 text-sm pb-4">
                            ...
                            <p>
                                Need support? Email us at <a href="mailto:info@cloudsentrics.com" className="underline">info@cloudsentrics.com</a> or WhatsApp <a href="https://wa.me/13463998985" className="underline">+1 (346) 399-8985</a>
                            </p>
