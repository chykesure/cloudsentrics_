    ...
    const handlePaymentSubmit = async (e) => {
        ...
        try {
            const res = await fetch('http://localhost:5000/create-payment-intent', {
                ...
                body: JSON.stringify({
                    amount: registrationFee,  // Sending the registration fee
                    email: formData.email,    // Sending the email address here
                }),
            });
            ...
            if (result.error) {
                ...
                // Inside the handlePaymentSubmit function, after successful payment:
                if (result.paymentIntent.status === 'succeeded') {
                    alert("✅ Payment Successful!");

                    // Send the form data to your backend
                    fetch('http://localhost:5000/enroll', { // Replace with your backend endpoint for enrollment
                        method: 'POST',
                        headers: { 'Content-Type': 'application/json' },
