        ...
        <>
            ...
            {isModalOpen && (
                <div className="fixed inset-0 bg-opacity-60 flex items-center justify-center z-50 px-4">
                    <div className="bg-[#1e4272] text-white w-full max-w-2xl md:max-w-3xl p-6 md:p-8 rounded-lg shadow-lg relative overflow-y-auto max-h-[90vh]">
                        <button
                            onClick={toggleModal}
                        ...
                        <form className="space-y-4">
                            ...
                            <div>
                                ...
                                <input type="text" className="w-full p-2 rounded bg-[] border border-gray-200 text-white" />
                            </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="email" className="w-full p-2 rounded bg-[] border border-gray-200 text-white" />
                                </div>
                                <div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <input
                                        type="text"
                                        placeholder="e.g., AWS DevSecOps, Cloud Security"
                                        className="w-full p-2 rounded bg-[] border border-gray-200 text-white"
                                    />
                                </div>
                            </div>
