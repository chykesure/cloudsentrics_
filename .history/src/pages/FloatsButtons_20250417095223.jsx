...
const FloatsButtons = () => {
    ...
    return (
        <>
            ...
            {/* Modal */}
            {isModalOpen && (
                <div className="fixed inset-0 bg-[#1e4272] bg-opacity-60 flex items-center justify-center z-50 px-4">
                    <div className="bg-[#1e1e1e] text-white w-full max-w-2xl md:max-w-3xl p-6 md:p-8 rounded-lg shadow-lg relative overflow-y-auto max-h-[90vh]">
                        <button
                            onClick={toggleModal}
