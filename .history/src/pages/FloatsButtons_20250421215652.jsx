            ...
            if (response.ok) {
                setSuccessMessage(`
                    <div className="mt-6 space-y-2 text-sm pb-4">
                        <p>
                            Your registration is successfu submitted, our team will review your information and contact you with the next steps, including payment instructions and course access details.
                        </p>
                        <p>
                            ...
                            <>
                                ...
                                <form ref={formRef} onSubmit={handleSubmit} className="space-y-4">
                                    ...
                                    <button
                                        type="submit"
                                        disabled={isLoading}
                                        className="mt-4 bg-red-500 text-white w-full p-2 rounded-lg"
                                    >
