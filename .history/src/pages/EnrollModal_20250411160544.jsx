...
const EnrollForm = ({ onClose }) => {
  ...
  return (
    <div className="fixed top-0 left-0 w-full h-full bg-black bg-opacity-60 flex justify-center items-center z-50">
      <div className="bg-white w-full h-full max-w-4xl p-8 rounded-xl shadow-lg relative overflow-auto">
        <button
        ...
        {step === 2 && (
          <>
            <h2 className="text-2xl font-bold mb-6">Step 2: Course & Payment Option</h2>
            ...
            <div className="mb-6">
              <label htmlFor="paymentMethod" className="block font-semibold mb-2">Payment Option</label>
              <select
                id="paymentMethod"
                name="paymentMethod"
        ...
        {step === 3 && (
          <>
            <h2 className="text-2xl font-bold mb-6">Step 3: Payment</h2>

            <div className="mb-6">
              <label htmlFor="cardDetails" className="block font-semibold mb-2">Card Details</label>
