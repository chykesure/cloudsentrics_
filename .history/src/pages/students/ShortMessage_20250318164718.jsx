  ...
  return (
    <div className="relative w-full bg-[#0f172a] text-white py-16 px-6 md:px-12 flex justify-center items-center text-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl">
        ...
        {/* Enroll Button (Simple Hover Effect) */}
        <button className="mt-6 bg-white text-black font-semibold py-3 px-8 rounded-lg shadow-lg transition-all duration-300 hover:scale-105 hover:bg-gray-300">
          ENROLL NOW
        </button>
      </div>
