...
const badges = {
    ...
    Azure: [
        { title: 'Badge 11', img: "/assets/AZ1.jpg" },
        { title: 'Badge 11', img: "/assets/AZ2.jpg" },
        { title: 'Badge 11', img: "/assets/AZ3.jpg" },
        { title: 'Badge 11', img: "/assets/AZ4.jpg" },
        { title: 'Badge 11', img: "/assets/AZ5.jpg" },
        { title: 'Badge 11', img: "/assets/AZ6.jpg" },
        { title: 'Badge 11', img: "/assets/AZ7.jpg" },
        { title: 'Badge 11', img: "/assets/AZ8.jpg" },
        { title: 'Badge 11', img: "/assets/AZ9.jpg" },
        { title: 'Badge 11', img: "/assets/AZ10.jpg" },
        { title: 'Badge 11', img: "/assets/AZ11.jpg" },
    ],
};
    ...
    return (
        <section className="bg-[#1e4272] text-white py-16 px-6 sm:px-12 lg:px-20 shadow-2xl shadow-gray-900">
            ...
            <div className="text-center mb-12">
                ...
                Leading <span className="text-yellow-400">Cloud Security </span>Solutions Provider
                </h2>
