                        ...
                        <div key={i} className="w-full text-center relative group">
                            {menu.options ? (
                                <div className="relative">
                                    ...
                                    {dropdownOpen === i && (
                                        <div className="bg-white shadow-md rounded-md w-full mt-2 border border-gray-200 flex flex-col items-center py-2">
                                            {menu.options.map((option, j) => (
                                                <Link
                                                    key={j}
                                                    to={option.path}
                                                    className="flex items-center justify-center gap-3 px-5 py-3 text-xl hover:bg-[#1e4272] hover:text-white transition-all duration-300 rounded-md w-11/12"
                                                >
                                                    {option.icon}
                                                    {option.label}
                                                </Link>
