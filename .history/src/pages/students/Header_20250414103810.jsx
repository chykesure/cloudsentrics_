...
const Header = () => {
    ...
    return (
        <header className="flex items-center justify-between px-6 py-4 bg-white shadow-md fixed top-0 left-0 w-full z-50">
            ...
            {/* Enroll Button */}
            <Link to="/enroll" className="hidden lg:flex items-center bg-[#1e4272] text-white px-6 py-3 text-xl font-semibold rounded-md shadow-md hover:bg-[#16315a] transition-all">
                Enroll Now!!
            </Link>
