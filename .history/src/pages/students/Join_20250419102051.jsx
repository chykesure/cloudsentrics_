...
const Join = () => {
  ...
  const handleJoinClick = () => {
    ...
    const message = `Hello! I am interested in joining the Community.%0A%0AName: ${name}%0AEmail: ${email}`;
    // WhatsApp custom message link provided by you
    const whatsappLink = "https://wa.me/message/62QVNSESZ56FC1";

    // Append the pre-filled message to the link
