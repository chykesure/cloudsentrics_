...
const sign = "/assets/devs-img.jpg";
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        {[
                            ...
                            },
                            {
                                ...
                                description: "Master DevSecOps at your own pace with 128+ hours of expert-led training over 4 months - Saturdays & Sundays only. Gain hands-on experience through on-demand video lessons and interactive exercises to become job-ready!",
                            },
                            /* {
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-stretch">
        ...
        <div className="rounded-lg overflow-hidden shadow-lg h-full flex">
            <img
                ...
                className="w-full h-full object-cover"  {/* Adjust to object-contain if you need to avoid cropping */}
            />
        </div>
