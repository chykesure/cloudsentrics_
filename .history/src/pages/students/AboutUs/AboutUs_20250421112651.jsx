...
import founderImg from './assets/founder.jpg'; // update the path if different
...
const AboutUs = () => {
    ...
    const countries = ['Nigeria', 'United States', 'Canada', 'United Kingdom', 'Ghana']; // Add more as needed
