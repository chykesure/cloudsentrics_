...
const facultyMembers = [
    { name: "OLUDARE ODO", title: "Senior Cloud Security Engineer/Instructor
", icon: <FaCloud size={50} className="text-white-500" /> },
    { name: "EMMANUEL PIUS-OGIJI", title: "Senior DevSecOps Engineer at Minte", icon: <FaServer size={50} className="text-white-500" /> },
