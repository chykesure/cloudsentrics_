...
const AboutUs = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        // Collect form data using formRef
        const data = {
            user_name: formRef.current.user_name.value,
            user_email: formRef.current.user_email.value,
            user_phone: formRef.current.user_phone.value,
            user_country: formRef.current.user_country.value,
        };
    ...
    return (
        <div className="min-h-screen bg-gray-50">
            ...
            <div className="w-full px-6 md:px-20 lg:px-32 py-20">
                ...
                <section className="flex flex-col md:flex-row items-center justify-center bg-[#1e4272] text-white p-8 rounded-lg max-w-5xl mx-auto mt-14 shadow-lg">
