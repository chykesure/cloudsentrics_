...
import { FaCloud, FaServer, FaPython, FaUserShield, FaMoneyBillTrendUp, FaDocker, FaLock, FaNetworkWired, FaRocket, FaWhatsapp } from "react-icons/fa";
...
const facultyMembers = [
    ...
    { name: "Emmanuel Odo", title: "Cloud Sales Engineer", icon: <FaMoneyBillTrendUp  size={50} className="text-white-500" /> },
