...
const facultyMembers = [
    { name: "OLUWARE ODO", title: "Senior Cloud Security Engineer/Instructor", icon: <FaCloud size={50} className="text-white-500" /> },
            ...
            <div className="w-full px-6 md:px-20 lg:px-32 py-20">
                ...
                <section className="flex flex-col md:flex-row items-center bg-[transperent] text-black py-16 px-6 sm:px-12 lg:px-20 mt-14">
                    ...
                    <div className="md:w-1/2 text-center md:text-left">
                        ...
                        <h2 className="text-5xl font-bold leading-tight">Meet Oluwadamilare Odo</h2>
