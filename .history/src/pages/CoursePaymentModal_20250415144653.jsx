            ...
            <div className="bg-white w-full max-w-3xl p-8 rounded-lg shadow-xl relative overflow-auto max-h-[90vh]">
                ...
                {step === 3 && (
                    <>
                        ...
                        <div className="mb-6">
                            <label className="block text-sm font-medium text-gray-600 mb-2">Credit/Debit Card</label>
                ...
                {step === 4 && (
                    <div className="text-center">
                        <h2 className="text-2xl font-semibold mb-4 text-gray-800">Thank You for Your Payment!</h2>
                        <p>Your payment was successful, and you are now enrolled in the course!</p>
                    </div>
                )}
            </div>
        </div>
