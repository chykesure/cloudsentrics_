...
const CourseForm = ({ onClose }) => {
    ...
    const [formData, setFormData] = useState({
        ...
        paymentMethod: '',
        token: '',
        amount: '', // Add this to store the one-time payment amount
    });
            ...
            <div className="bg-white w-full max-w-3xl p-8 rounded-lg shadow-xl relative overflow-auto max-h-[90vh]">
                ...
                {step === 3 && (
                    <>
                        ...
                        <div className="mb-6">
                            <label className="block text-sm font-medium text-gray-600 mb-2">Payment Information</label>
                ...
                {step === 4 && (
                    <div className="text-center">
                        ...
                        <p className="text-lg text-gray-600">Thank you for registering for the course.</p>
                    </div>
                )}
            </div>
        </div>
