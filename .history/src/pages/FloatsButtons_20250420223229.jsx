...
const FloatsButtons = () => {
    ...
    return (
        <>
            ...
            <motion.a
                href="https://wa.me/message/62QVNSESZ56FC1"https://wa.me/message/CGPT5WGTUAS3B1
                target="_blank"
            ...
            {/* Modal */}
            {isModalOpen && (
                <div className="fixed inset-0  bg-opacity-60 flex items-center justify-center z-[100] px-4 sm:px-6 py-6 overflow-y-auto">

                    {/* Floating Notice */}
                    {/* <div className="absolute top-4 left-1/2 transform -translate-x-1/2 z-[110] text-white text-center text-base sm:text-xl font-semibold bg-red-600 px-4 py-2 rounded shadow-lg">
