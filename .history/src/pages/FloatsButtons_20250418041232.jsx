...
const FloatsButtons = () => {
    ...
    return (
        <>
            ...
            {/* Modal */}
            {isModalOpen && (
                <div className="fixed inset-0 bg-opacity-60 flex items-center justify-center z-60 px-4 py-6 sm:px-6 overflow-y-auto">

                    {/* Floating Text */}
                    <div className="absolute top-4 left-1/2 transform -translate-x-1/2 z-70 text-white text-xl font-semibold bg-red-600 px-4 py-2 rounded shadow-lg">
                        🚀 Enroll Now – Limited Slots Available!
                    </div>

                    <div className="bg-[#1e4272] text-white w-full max-w-[95%] sm:max-w-2xl p-4 sm:p-8 rounded-lg shadow-lg relative max-h-full overflow-y-auto">
                        ...
                        <form className="space-y-4 max-h-[60vh]">
                            <div>
