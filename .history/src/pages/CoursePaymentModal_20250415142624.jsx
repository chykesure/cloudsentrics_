...
const CourseForm = ({ onClose }) => {
  ...
  const [courseFee, setCourseFee] = useState(15000);
  ...
  return (
    <div className="fixed top-0 left-0 w-full h-full bg-black bg-opacity-60 flex justify-center items-center z-50">
      <div className="bg-white w-full max-w-3xl p-8 rounded-lg shadow-xl relative overflow-auto max-h-[90vh]">
        ...
        {step === 0 && (
          <>
            <h2 className="text-2xl font-semibold mb-6 text-center text-gray-800">Enter Your Token</h2>
            <div className="mb-4">
        ...
        {step === 1 && (
          <>
            <h2 className="text-2xl font-semibold mb-6 text-center text-gray-800">Step 1: Personal Details</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
              <div>
                <label className="block text-sm font-medium text-gray-600 mb-2">Full Name</label>
                <input type="text" name="fullName" value={formData.fullName} onChange={handleChange} className="w-full p-3 border border-gray-300 rounded-md" />
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-600 mb-2">Phone</label>
                <input type="tel" name="phone" value={formData.phone} onChange={handleChange} className="w-full p-3 border border-gray-300 rounded-md" />
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-600 mb-2">Country</label>
                <select name="country" value={formData.country} onChange={handleChange} className="w-full p-3 border border-gray-300 rounded-md">
        ...
        {step === 2 && (
          <>
            <h2 className="text-2xl font-semibold mb-6 text-center text-gray-800">Step 2: Course & Payment Option</h2>
            <div className="mb-6">
              <label className="block text-sm font-medium text-gray-600 mb-2">Course</label>
              <select name="course" value={formData.course} onChange={handleChange} className="w-full p-3 border border-gray-300 rounded-md">
            ...
            <div className="mb-6">
              ...
              <select name="paymentMethod" value={formData.paymentMethod} onChange={handleChange} className="w-full p-3 border border-gray-300 rounded-md">
        ...
        {step === 3 && (
          <>
            <h2 className="text-2xl font-semibold mb-6 text-center text-gray-800">Step 3: Payment</h2>
            <div className="mb-6">
            ...
            <div className="mb-6 text-xl font-semibold text-gray-800">
              Registration Fee: ${courseFee / 100}
            </div>
            <button
              disabled={!stripe}
              className={`w-full bg-green-600 text-white py-3 rounded-md ${!stripe ? 'opacity-50 cursor-not-allowed' : 'hover:bg-green-700'}`}
        ...
        {step === 4 && (
          <div className="text-center">
            ...
            <button className="bg-[#1e4272] text-white px-6 py-3 rounded-md hover:bg-blue-800" onClick={onClose}>
              Close
            </button>
          </div>
        )}
