                    ...
                    <>
                        ...
                        {formData.country && formData.paymentMethod && (
                            <div className="mb-6 text-center text-gray-700 font-medium">
                                {(() => {
                                    const conversion = getCurrencyInfo(formData.country, formData.paymentMethod === 'installment' ? (formData.amount || 0) : 3000);
                                    return conversion
                                        ? `Equivalent: ${conversion.currency} ${conversion.amount}`
                                        : null;
                                })()}
                            </div>
                        )}
