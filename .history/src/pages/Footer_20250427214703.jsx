            ...
            <div className="max-w-full mx-auto px-8 sm:px-14 lg:px-16">
                <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-8 text-center md:text-left">
                    ...
                    <div className="md:col-span-1 lg:col-span-2 max-w-lg">
                        ...
                        <p className="text-lg text-gray-300 mt-4 leading-relaxed">
                            At Cloud Sentrics, we empower individuals, no matter their background to excel in Cloud DevSecOps through expert-led, hands-on training and globally recognized certifications.

                            We also help businesses achieve secure, scalable, and seamless cloud integration. Our consulting services deliver end-to-end support, from strategy and deployment to optimization, ensuring your cloud journey is secure and future-ready.
                        </p>
                        <p className="text-lg text-gray-300 mt-4 leading-relaxed">
                            At the same time, businesses trust Cloud Sentrics for tailored cloud solutions that align with their goals. We combine deep expertise in cloud technologies and DevSecOps with end-to-end support from consultation to deployment and ongoing optimization ensuring secure, scalable, and seamless integration for our clients.
                        </p>
                ...
                hover:scale-110 hover:rotate-6 hover:shadow-lg">
                    ...
                    <div className="text-center md:text-left">
                        ...
                        <div className="space-y-3 text-lg text-gray-300 flex flex-col items-center md:items-start">
                            {[
                                { Icon: FaMapMarkerAlt, text: "22507 Cappella Village Lane, Katy, TX 77449" },
                                { Icon: FaPhone, text: "+1 346-580-6298" },
                ...
                <div className="border-t border-gray-500 mt-8 pt-5 text-center text-lg text-gray-300">
                    ...
                    <div className="flex justify-center space-x-5 mt-3">
                        <button onClick={() => openModal("Privacy Policy", privacyText)} className="hover:text-white">Privacy Policy</button>
                        <span className="text-gray-400">|</span>
                        <button onClick={() => openModal("Terms & Conditions", termsText)} className="hover:text-white">Terms & Conditions</button>
                        <span className="text-gray-400">|</span>
                        <button onClick={() => openModal("Sitemap", sitemapText)} className="hover:text-white">Sitemap</button>
                    </div>
                </div>
