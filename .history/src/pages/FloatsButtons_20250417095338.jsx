                    ...
                    <div className="bg-[#1e4272] text-white w-full max-w-2xl md:max-w-3xl p-6 md:p-8 rounded-lg shadow-lg relative overflow-y-auto max-h-[90vh]">
                        ...
                        <form className="space-y-4">
                            ...
                            <div>
                                ...
                                <input type="text" className="w-full p-2 rounded bg-[] border border-gray-600 text-white" />
                            </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="email" className="w-full p-2 rounded bg-[] border border-gray-600 text-white" />
                                </div>
                                <div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        className="w-full p-2 rounded bg-[] border border-gray-600 text-white"
                                    />
                                </div>
                            </div>
