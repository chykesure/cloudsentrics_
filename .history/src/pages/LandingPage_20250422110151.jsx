...
const LandingPage = () => {
    ...
    return (
        ...
        >
            ...
            <div className="w-full px-4 md:px-6 mb-12 space-y-12">
  {/* === FOR STUDENTS SECTION === */}
  <motion.section
    whileHover={{ y: -5, boxShadow: "0px 5px 15px rgba(0,0,0,0.1)" }}
    transition={{ duration: 0.3 }}
    className="bg-white/80 rounded-xl shadow-md p-6 md:p-10"
  >
    {/* Image on Top */}
    <img
      src={trainingImage}
      alt="Student Learning"
      className="w-full h-auto max-h-[300px] object-cover rounded-lg mb-6"
    />
    ...
    <div className="space-y-6">
      <div>
        <h3 className="text-lg font-semibold text-gray-800">Real-World Learning Approach</h3>
      ...
      <div>
        <h3 className="text-lg font-semibold text-gray-800">Industry-Relevant Skills</h3>
        <p className="text-gray-600 text-sm">
      ...
      <div>
        <h3 className="text-lg font-semibold text-gray-800">Personalized Mentorship</h3>
        <p className="text-gray-600 text-sm">
      ...
      <div>
        <h3 className="text-lg font-semibold text-gray-800">Job Placement Support</h3>
        <p className="text-gray-600 text-sm">
  ...
  >
    ...
    <div className="space-y-6">
      <div>
        <h3 className="text-lg font-semibold text-gray-800">Seamless On-Prem to Cloud Migration</h3>
        <p className="text-gray-600 text-sm">
      ...
      <div>
        <h3 className="text-lg font-semibold text-gray-800">End-to-End Cloud Security</h3>
        <p className="text-gray-600 text-sm">
      ...
      <div>
        <h3 className="text-lg font-semibold text-gray-800">Optimized Cloud Networking</h3>
        <p className="text-gray-600 text-sm">
      ...
      <div>
        <h3 className="text-lg font-semibold text-gray-800">Tailored Cloud Solutions</h3>
        <p className="text-gray-600 text-sm">
      ...
      <div>
        <h3 className="text-lg font-semibold text-gray-800">Qualified Cloud Professionals</h3>
        <p className="text-gray-600 text-sm">
    ...
    <motion.button
      whileHover={{ scale: 1.05 }}
      transition={{ duration: 0.2 }}
      className="mt-8 bg-green-600 text-white px-6 py-3 rounded-md hover:bg-green-700"
