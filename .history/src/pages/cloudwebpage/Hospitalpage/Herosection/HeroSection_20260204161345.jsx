      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-5 md:px-6 lg:px-7 xl:px-8 py-12 md:py-16 lg:py-20">
        <div className="max-w-xl sm:max-w-2xl lg:max-w-3xl text-left ml-0 md:ml-0 lg:ml-2 xl:ml-4 pr-6 sm:pr-10 lg:pr-16 xl:pr-2">
          <motion.h1
            ...
            className="text-4xl sm:text-5xl md:text-6xl lg:text-6xl xl:text-5xl font-extrabold tracking-tight leading-tight mb-6 md:mb-8"
          >
            <span className="block text-cyan-400">
              Empower Your Hospital with
            </span>
            <span className="block text-cyan-400">
          ...
          >
            Healthcare is undergoing a digital transformation to improve patient care, streamline operations, and reduce costs. Cloud Sentrics enables hospitals to securely store, manage, and share sensitive medical records, ensuring compliance with data protection regulations while enhancing collaboration among staff.
          </motion.p>
