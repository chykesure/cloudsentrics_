    ...
    <section className="relative min-h-[80vh] sm:min-h-[90vh] md:min-h-screen flex items-center overflow-hidden bg-slate-950 text-white">
      ...
      <div className="absolute inset-0 z-0">
        <img
          ...
          className="w-full h-full object-cover object-center brightness-[1.78] contrast-[1.78] saturate-[0.92]"
        />
        {/* Darker vignette + blue tint to match reference mood */}
        <div className="absolute inset-0 bg-gradient-to-r from-slate-950/80 via-slate-950/65 to-slate-950/75" />
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-5 md:px-6 lg:px-7 xl:px-8 py-12 md:py-16 lg:py-20">
        <div className="max-w-xl sm:max-w-2xl lg:max-w-3xl text-left ml-0 md:ml-0 lg:ml-2 xl:ml-4 pr-6 sm:pr-10 lg:pr-16 xl:pr-2">
          ...
          >
            Cloud Sentrics provides law firms with a secure and easy-to-use platform to store, manage, and share confidential legal documents. Collaborate seamlessly with staff and clients while maintaining strict control over sensitive case files and client information. Built with compliance and security at its core, Cloud Sentrics helps legal practices operate efficiently in the digital environment without compromising confidentiality or regulatory requirements.
          </motion.p>
