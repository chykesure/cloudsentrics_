    ...
    <>
      ...
      <section className="relative bg-gradient-to-b from-blue-950 via-indigo-950 to-blue-950 py-16 md:py-24 lg:py-32 overflow-hidden text-white">
        ...
        <div className="relative max-w-7xl mx-auto px-5 sm:px-8 lg:px-10">
          <h2 className="text-center text-4xl sm:text-5xl md:text-6xl lg:text-4xl font-extrabold tracking-tight mb-10 md:mb-14 lg:mb-16">
          ...
          <p className="text-center mt-10 md:mt-14 text-lg sm:text-xl md:text-2xl opacity-90 max-w-3xl mx-auto">
            Cloud Sentrics Limited was recently unveiled on Channels Television, highlighting our commitment to advancing secure cloud storage, data protection, and controlled file-sharing solutions across Africa.

The feature showcased our mission to help organizations safeguard sensitive information, improve compliance, and drive operational efficiency through enterprise-grade cloud technologies. It also emphasized our role in empowering businesses and institutions with secure, scalable, and locally compliant data-management solutions.

Watch the full unveiling to learn more about our vision, impact, and the future we are building in secure digital transformation.
          </p>
        </div>
      </section>
