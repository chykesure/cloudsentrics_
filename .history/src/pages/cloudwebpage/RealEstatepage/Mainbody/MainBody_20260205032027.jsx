      ...
      <section className="bg-gray-50 py-16 md:py-24 lg:py-32">
        <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
          ...
          <div className="text-center max-w-4xl mx-auto">
            {/* Main Heading – dark blue like in your screenshot */}
            <h2 className="text-3xl sm:text-4xl lg:text-4xl font-extrabold text-gray-900 tracking-tight leading-tight mb-8 md:mb-12">
              A Secure Workspace for Real Estate Teams
            </h2>

            {/* Descriptive text – matches your content closely */}
            <div className="text-lg md:text-xl text-gray-700 leading-relaxed mb-12 space-y-6">
              <p>
                Cloud Sentrics helps real estate agencies, property managers, and brokerages store, manage, and share property documents and client information securely.
                Teams can access contracts, listings, and client files from any device or location, with least-privilege access ensuring sensitive information is only available to authorized staff.
                All activities are auditable, and secure sharing with clients is protected via One-Time Passcodes (OTP) and expiry controls.
              </p>

              <p>
                From managing property documents to collaborating with clients and partners, Cloud Sentrics enables efficient, compliant, and secure workflows supporting growth while keeping sensitive data under your control.
              </p>
            </div>

            {/* Centered Get Started button – dark blue, prominent */}
            <div className="mt-8">
              <a
                href="#get-started" // ← replace with your actual link or form handler
                className="inline-block bg-blue-900 text-white font-semibold text-lg px-10 py-4 rounded-lg shadow-md hover:bg-blue-800 transition-colors duration-200"
              >
                Get started
              </a>
            </div>
