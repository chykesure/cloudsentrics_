...
const HeroSection = () => {
  ...
  return (
    <>
        ...
        <div className="relative z-10 max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            >
              <img
                src="/hmp3.png"
                alt="Trust shield with glowing lock"
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            >
              <img
                src="/hmp2.png"
                alt="Data governance cloud network illustration"
                className="w-full max-w-lg object-contain drop-shadow-2xl"
              />
            </motion.div>
          </div>
      ...
      {/* Section 6: Prefer a SaaS Solution CTA (kept as-is, but updated text to match your image) */}
      <section className="relative text-white py-20 md:py-28 px-6 overflow-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto text-center">
          <motion.div
            ...
            transition={{ duration: 0.9 }}
          >
            <h4 className="text-2xl sm:text-3xl md:text-4xl font-semibold leading-tight tracking-tight mb-10 max-w-5xl mx-auto">
