...
const HeroSection = () => {
  ...
  return (
    <>
      ...
      {/* New Section 4: Built for Trust, Not Assumptions */}
      <section className="relative bg-white text-slate-900 py-20 md:py-32 px-6 lg:px-12">
        <div className="max-w-5xl mx-auto">
          <motion.div
            initial={{ opacity: 0, y: 40 }}
          ...
          >
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-12">
              Built for Trust, Not Assumptions
            </h2>
            ...
            {/* Optional: Add image here if you have one (e.g., the shield from your mockup) */}
            {/* <img src="/trust-shield.png" alt="Trust Shield" className="mt-12 w-full max-w-lg mx-auto rounded-2xl shadow-xl" /> */}
          </motion.div>
        </div>
      </section>

      {/* New Section 5: Built for Organizations with Strict Data Governance */}
      <section className="relative bg-white text-slate-900 py-20 md:py-32 px-6 lg:px-12">
        <div className="max-w-5xl mx-auto">
          <motion.div
            initial={{ opacity: 0, y: 40 }}
          ...
          >
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-12">
              Built for Organizations with Strict Data Governance
            </h2>
            ...
            {/* Optional: Add image here if you have one (e.g., the cloud diagram from your mockup) */}
            {/* <img src="/data-governance-cloud.png" alt="Data Governance Cloud" className="mt-12 w-full max-w-lg mx-auto rounded-2xl shadow-xl" /> */}
          </motion.div>
        </div>
      </section>

      {/* Updated Section 6: CTA (updated text and button style to match your mockup) */}
        ...
        <div className="relative z-10 max-w-6xl mx-auto text-center">
          ...
          >
            <h4
              ...
              "
            >
              Ready to secure your data fully? Let's talk.
            </h4>
            ...
            <motion.button
              ...
              className="
                ...
                text-xl shadow-2xl shadow-cyan-500/30
                transition-all duration-300
              "
            >
              Let's Talk
