...
const HeroSection = () => {
  return (
    <>
      ...
      {/* Section 3: Why Cloud Sentrics? – dark blue background with image layout */}
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            >
              <img
                src="/hmp1.jpg"
                alt="Team using Cloud Sentrics in professional setting"
            ...
            >
              <div className="space-y-8">
                <div className="flex items-start gap-6">
                  <div className="flex-shrink-0 w-12 h-12 rounded-full bg-cyan-500/20 flex items-center justify-center text-2xl font-bold text-cyan-400 border border-cyan-400/40">
                    1
                  </div>
                  <div>
                    <h3 className="text-2xl font-semibold mb-3">Security First, Always.</h3>
                ...
                <div className="flex items-start gap-6">
                  ...
                  <div>
                    <h3 className="text-2xl font-semibold mb-3">Compliance You Can Trust</h3>
                    <p className="text-slate-300 leading-relaxed">
                      Cloud Sentrics is NDPC-compliant and CAC-registered in Nigeria, with solutions designed to support GDPR, HIPAA-aligned data protection requirements. Our infrastructure and processes help organizations meet regulatory obligations without complexity.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-6">
                  ...
                  <div>
                    <h3 className="text-2xl font-semibold mb-3">Data Control and Ownership</h3>
                    <p className="text-slate-300 leading-relaxed">
                      Your data remains under your control at all times. Cloud Sentrics is built to prevent vendor lock-in and hidden access paths, giving organizations full transparency, ownership, and confidence in how their files are stored and shared.
                    </p>
                  </div>
                </div>
