...
const HeroSection = () => {
  ...
  return (
    <>
      ...
      {/* === NEW SECTION ADDED: Built for Trust, Not Assumptions (matches your image - dark background + shield) === */}
      <section className="relative bg-gradient-to-b from-[#0a1a3f] to-[#071029] text-white py-24 md:py-32 px-6 lg:px-12 overflow-hidden">
        <div className="absolute inset-0 opacity-30 pointer-events-none">
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_30%_20%,rgba(6,182,212,0.12)_0%,transparent_50%)]" />
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_70%_80%,rgba(6,182,212,0.08)_0%,transparent_60%)]" />
        </div>

        <div className="relative z-10 max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            {/* Shield Image - Left on large screens */}
            <motion.div
            ...
            >
              <img
                src="/hmp3.png"
                alt="Glowing blue shield representing trust and security"
                className="w-full max-w-md lg:max-w-lg object-contain drop-shadow-[0_0_60px_rgba(6,182,212,0.4)]"
              />
            </motion.div>
            ...
            >
              ...
              <p className="text-lg md:text-xl leading-relaxed text-slate-200">
                Cloud Sentrics is designed to help organizations move away from unsecured storage methods such as shared drives, email attachments, local servers, and unmanaged third-party tools without disrupting existing on-premises or through a hybrid setup.
              </p>
      ...
      {/* === NEW SECTION ADDED: Built for Organizations with Strict Data Governance (matches your image - white + cloud diagram) === */}
      <section className="relative bg-white text-slate-900 py-24 md:py-32 px-6 lg:px-12">
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            >
              ...
              <p className="text-lg md:text-xl leading-relaxed">
                Take full control of your data anytime, anywhere. Deploy Cloud Sentrics on-premises, in your preferred data center, or through a hybrid setup.
              </p>
            ...
            {/* Cloud Diagram Image - Right on large screens */}
            <motion.div
              initial={{ opacity: 0, scale: 0.85 }}
              whileInView={{ opacity: 1, scale: 1 }}
              viewport={{ once: true }}
            ...
            >
              <img
                src="/hmp2.png"
                alt="Cloud network with governance and control elements"
      ...
      {/* Final CTA – updated to exactly match your mockup */}
      <section className="relative py-20 md:py-28 px-6 overflow-hidden bg-gradient-to-b from-slate-950 to-[#0a1a3f]">
        ...
        <div className="relative z-10 max-w-5xl mx-auto text-center">
          <motion.div
            ...
            transition={{ duration: 0.9 }}
          >
            <h3 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-10 leading-tight">
              Ready to secure your data fully?<br className="hidden sm:block" /> Let's talk.
            </h3>
            ...
            <motion.button
              ...
              className="
                ...
                hover:from-cyan-400 hover:to-blue-500
                text-white font-semibold
                px-12 md:px-16 py-5 md:py-6 rounded-xl
                text-xl md:text-2xl
                shadow-2xl shadow-cyan-600/40
                transition-all duration-300
              "
            >
              Let's Talk
