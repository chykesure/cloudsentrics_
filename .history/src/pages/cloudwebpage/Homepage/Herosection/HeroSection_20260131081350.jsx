...
const HeroSection = () => {
  return (
    <>
      {/* Hero Section – main visual banner */}
      ...
      {/* New Section: About Cloud Sentrics – right below hero */}
      <section className="relative bg-slate-950 text-white py-20 md:py-32 px-6 lg:px-12">
