        ...
        <div className="relative z-10 max-w-7xl mx-auto space-y-20 md:space-y-32">
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            >
              ...
              <p className="text-lg md:text-xl leading-relaxed text-slate-800">
                Our platform supports organizations operating under strict regulatory and governance requirements by delivering visibility, accountability, and confidence in how critical information is stored, accessed, and shared.
              </p>
            </motion.div>
