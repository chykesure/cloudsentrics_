...
const HeroSection = () => {
  return (
    <>
      ...
      {/* Section 4: Prefer a SaaS Solution CTA – matched to image */}
      <section className="relative bg-[#0a1a3f] text-white py-20 md:py-28 px-6 lg:px-12 overflow-hidden">
        <div className="absolute inset-0 z-0">
          <img
            src="/hmp7.png"
            ...
            className="w-full h-full object-cover object-center"
          />
          <div className="absolute inset-0 bg-gradient-to-t from-[#0a1a3f]/85 via-[#0a1a3f]/60 to-transparent" />
        </div>
        ...
        <div className="relative z-1 max-w-5xl mx-auto text-center">
          <motion.div
            ...
            transition={{ duration: 1 }}
          >
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-semibold tracking-tight leading-tight mb-10 md:mb-12">
