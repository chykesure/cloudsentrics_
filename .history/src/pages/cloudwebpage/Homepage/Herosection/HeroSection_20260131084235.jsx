...
const HeroSection = () => {
  return (
    <>
      ...
      <section className="relative bg-[#0a1a3f] text-white py-20 md:py-32 px-6 lg:px-12 overflow-hidden">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="space-y-16 md:space-y-20">
            ...
            {/* Bottom part: Points 5, 6, 7 – horizontal cards */}
            <motion.div
      ...
      {/* Section 4: Prefer a SaaS Solution? – fixed size & position */}
      <section
        className="relative bg-[#0a1a3f] text-white overflow-hidden"
        style={{
          width: '1045px',
          height: '285px',
          marginTop: '3715px',      // top: 3715px
          marginLeft: '198px',      // left: 198px
          opacity: 1,
        }}
      >
        {/* Background image – hmp7.png */}
        <div className="absolute inset-0 z-0">
          <img
            src="/hmp7.png"
            alt="SaaS solution illustration with robots and data flow"
            className="w-full h-full object-cover object-center"
          />
          {/* Dark overlay for text readability */}
          <div className="absolute inset-0 bg-gradient-to-t from-[#0a1a3f]/90 via-[#0a1a3f]/70 to-transparent" />
        </div>

        {/* Content – centered vertically & horizontally */}
        <div className="relative z-10 h-full flex flex-col items-center justify-center text-center px-10 md:px-16">
          <motion.div
            ...
            transition={{ duration: 1 }}
          >
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold leading-tight mb-8">
              Prefer a SaaS Solution? Discover how Cloud Sentrics can
              <br className="hidden md:block" />
              simplify secure data storage, protection, and sharing for your organization.
            </h2>
            ...
            <motion.button
              ...
              className="
                ...
                hover:from-cyan-400 hover:to-blue-500
                text-white font-semibold
                px-12 md:px-20 py-5 md:py-6 rounded-full
                text-xl md:text-2xl
                shadow-2xl shadow-cyan-500/30
                border border-cyan-400/30
                transition-all duration-300
