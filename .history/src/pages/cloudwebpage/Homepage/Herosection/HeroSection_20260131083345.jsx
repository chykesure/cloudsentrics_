...
const HeroSection = () => {
  return (
    <>
      ...
      {/* Section 4: Prefer SaaS Solution CTA – new dark section */}
      <section className="relative bg-[#0a1a3f] text-white py-24 md:py-40 px-6 lg:px-12 overflow-hidden">
        <div className="absolute inset-0 z-0">
          <img
            src="/hmp7.png"
            alt="SaaS solution illustration"
        ...
        <div className="relative z-10 max-w-6xl mx-auto text-center">
          <motion.div
            ...
            transition={{ duration: 1 }}
          >
            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-10 md:mb-14">
            ...
            <motion.button
              ...
              className="
                ...
                hover:from-cyan-400 hover:to-blue-500
                text-white font-semibold
                px-12 md:px-20 py-6 md:py-7 rounded-full
                text-xl md:text-2xl
                shadow-2xl shadow-cyan-500/30
                border border-cyan-400/30
                transition-all duration-300
