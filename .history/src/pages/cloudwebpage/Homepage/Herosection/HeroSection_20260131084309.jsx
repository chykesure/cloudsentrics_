...
const HeroSection = () => {
  return (
    <>
      ...
      {/* Section 4: Prefer SaaS Solution CTA – exact positioning & size */}
<section
...
>
  ...
  <div className="absolute inset-0 z-0">
    ...
    <div className="absolute inset-0 bg-gradient-to-t from-[#0a1a3f]/80 via-[#0a1a3f]/50 to-transparent" />
  </div>

  {/* Content – centered vertically & horizontally */}
  <div className="relative z-10 h-full flex flex-col items-center justify-center text-center px-12 md:px-16">
    <motion.div
      ...
      transition={{ duration: 1 }}
    >
      <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold leading-tight mb-8 md:mb-10">
