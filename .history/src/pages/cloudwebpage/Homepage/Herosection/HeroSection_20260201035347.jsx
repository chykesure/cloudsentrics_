...
const HeroSection = () => {
  ...
  return (
    <>
      ...
      {/* === NEW ADDED SECTION: Built for Trust, Not Assumptions === */}
      <section className="relative bg-[#0a1a3f] text-white py-24 md:py-32 px-6 lg:px-12 overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-40 pointer-events-none">
          ...
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_80%_70%,rgba(6,182,212,0.12)_0%,transparent_70%)]" />
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            >
              <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight">
                Built for Trust,<br />Not Assumptions
              </h2>
      ...
      {/* === NEW ADDED SECTION: Built for Organizations with Strict Data Governance === */}
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              transition={{ duration: 1, delay: 0.3 }}
              className="space-y-6 lg:text-left text-center order-2 lg:order-1"
            >
              <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight">
                Built for Organizations with<br />Strict Data Governance
              </h2>
      ...
      {/* Section 4: Prefer a SaaS Solution CTA (updated text & button to better match your mockup) */}
      <section className="relative text-white py-20 md:py-28 px-6 overflow-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto text-center">
          <motion.div
            ...
            transition={{ duration: 0.9 }}
          >
            <h4 className="text-3xl md:text-4xl lg:text-5xl font-semibold leading-tight tracking-tight mb-10 max-w-5xl mx-auto">
              Ready to secure your data fully?<br />Let's talk.
            </h4>
            ...
            <motion.button
              ...
              className="
                ...
                hover:from-cyan-400 hover:to-blue-500
                text-white font-semibold
                px-12 md:px-16 py-5 md:py-6 rounded-full
                text-xl md:text-2xl
