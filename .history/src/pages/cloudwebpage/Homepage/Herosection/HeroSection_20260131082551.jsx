        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            >
              <img
                src="/hmp1.jpng"
                alt="Team using Cloud Sentrics in professional environment"
                className="w-full h-auto object-cover"
              />
            </motion.div>

            {/* Right: Numbered benefits list (1–7) */}
            <motion.div
              initial={{ opacity: 0, x: 60 }}
              whileInView={{ opacity: 1, x: 0 }}
              viewport={{ once: true }}
            ...
            >
              <div className="space-y-10">
                ...
                <div className="flex items-start gap-6">
                  ...
                  <div>
                    <h3 className="text-2xl md:text-3xl font-semibold mb-4">Separation from Core Systems</h3>
                    <p className="text-slate-300 leading-relaxed text-lg">
                ...
                <div className="flex items-start gap-6">
                  ...
                  <div>
                    <h3 className="text-2xl md:text-3xl font-semibold mb-4">Built for Africa, Ready for the World</h3>
                    <p className="text-slate-300 leading-relaxed text-lg">
                ...
                <div className="flex items-start gap-6">
                  ...
                  <div>
                    <h3 className="text-2xl md:text-3xl font-semibold mb-4">Proven Real-World Expertise</h3>
                    <p className="text-slate-300 leading-relaxed text-lg">
