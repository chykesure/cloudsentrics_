...
const HeroSection = () => {
  ...
  "
      ...
      {/* === COMBINED SECTION: Trust & Strict Data Governance === */}
      <section className="relative text-white py-24 md:py-32 px-6 lg:px-12 overflow-hidden">
        {/* Background gradient transition from dark to lighter */}
        <div className="absolute inset-0 bg-gradient-to-b from-[#0a1a3f] via-[#0f254f] to-[#f8fafc]" />

        {/* Subtle particle/glow overlay only on the top half */}
        <div className="absolute inset-0 opacity-30 pointer-events-none">
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_20%_30%,rgba(6,182,212,0.15)_0%,transparent_60%)]" />
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_80%_40%,rgba(6,182,212,0.12)_0%,transparent_70%)]" />
        </div>

        <div className="relative z-10 max-w-7xl mx-auto space-y-20 md:space-y-32">
          {/* Part 1: Trust – dark mood */}
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            {/* Shield image – enhanced */}
            <motion.div
            ...
            >
              <div className="relative w-full max-w-md lg:max-w-lg overflow-hidden rounded-3xl shadow-2xl shadow-cyan-900/40 border border-cyan-500/20">
                <img
                  src="/hmp3.png"
                  alt="Glowing blue shield symbolizing trust and security"
                  className="
              w-full h-auto object-contain 
              rounded-3xl 
              shadow-inner 
              drop-shadow-[0_25px_70px_rgba(6,182,212,0.45)] 
              transition-all duration-500 
              hover:scale-[1.02] hover:brightness-110
            "
                />
                {/* Subtle overlay for depth */}
                <div className="absolute inset-0 bg-gradient-to-t from-black/15 to-transparent pointer-events-none rounded-3xl" />
              </div>
            </motion.div>
            ...
            <motion.div
              ...
              className="space-y-6 lg:text-left text-center order-1 lg:order-2"
            >
              <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight">
                Built for Trust,<br className="hidden lg:block" /> Not Assumptions
              </h2>

              <p className="text-lg md:text-xl leading-relaxed text-slate-200">
                Cloud Sentrics is designed to help organizations move away from unsecured storage methods such as shared drives, email attachments, local servers, and unmanaged third-party tools without disrupting existing on-premises or through hybrid setup.
              </p>

              <p className="text-lg md:text-xl leading-relaxed text-slate-200">
                We focus on secure storage, controlled access, and verifiable delivery not replacing your core operational systems.
              </p>

              <p className="text-lg md:text-xl leading-relaxed text-slate-200">
                With multi-factor authentication, strong encryption, and comprehensive file lifecycle management, your organization maintains complete ownership and oversight of sensitive information.
              </p>
            </motion.div>
          </div>
          ...
          {/* Part 2: Strict Data Governance – lighter mood */}
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            {/* Governance text */}
            <motion.div
              initial={{ opacity: 0, x: -40 }}
            ...
            >
              <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight text-slate-900">
                Built for Organizations with<br className="hidden lg:block" /> Strict Data Governance
              </h2>

              <p className="text-lg md:text-xl leading-relaxed text-slate-800">
                Cloud Sentrics is designed for organizations that handle sensitive and regulated information every day. We provide secure cloud storage with strong encryption, enforced access controls, and detailed audit trails to ensure data is protected, traceable, and compliant at all times.
              </p>

              <p className="text-lg md:text-xl leading-relaxed text-slate-800">
                Regulatory compliance and certifications? With multi-factor authentication, strong encryption, and comprehensive file lifecycle management, your organization maintains complete ownership and oversight of sensitive information.
              </p>
            </motion.div>

            {/* Cloud diagram image – enhanced */}
            <motion.div
              initial={{ opacity: 0, scale: 0.92 }}
              whileInView={{ opacity: 1, scale: 1 }}
              viewport={{ once: true }}
            ...
            >
              <div className="relative w-full max-w-md lg:max-w-lg overflow-hidden rounded-3xl shadow-2xl shadow-cyan-900/40 border border-cyan-500/20">
                <img
                  src="/hmp8.png"
                  alt="Cloud network illustration representing data governance and control"
                  className="
              w-full h-auto object-contain 
              rounded-3xl 
              shadow-inner 
