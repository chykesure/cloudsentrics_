  ...
  return (
    <>
      ...
      <div className="relative bg-gradient-to-b from-[#0a1a3f] to-[#071029] text-white overflow-hidden">
        ...
        {/* Section 3: Build Your Future with Cloud Sentrics – exact visual match */}
        <section className="relative py-24 md:py-32 px-6 lg:px-12 bg-white text-[#001F3F]">
          ...
          "
                ...
                {/* Compliance badges – horizontal row with checkmarks */}
                <div className="flex flex-wrap justify-center lg:justify-start gap-10 md:gap-16 mt-16">
                  {[
                    ...
                    <div key={i} className="flex flex-col items-center text-center w-28 md:w-auto">
                      <div className="w-14 h-14 md:w-16 md:h-16 rounded-full bg-blue-100 flex items-center justify-center text-2xl md:text-3xl text-blue-700 border-2 border-blue-500 mb-3">
                        ✓
                      </div>
                      <span className="font-bold text-base md:text-lg">{item.label}</span>
                      <span className="text-xs md:text-sm text-gray-500 mt-1">{item.full}</span>
                    </div>
                  ))}
                </div>
              </motion.div>
            ...
            "
                  />
                  {/* Subtle glow overlay to enhance the futuristic feel */}
