          ...
          <div className="max-w-7xl mx-auto">
            <div className="flex flex-col lg:flex-row items-center lg:items-start justify-center gap-12 lg:gap-16">
              ...
              <motion.div
                ...
                className="w-full lg:w-1/2 max-w-xl lg:max-w-2xl flex justify-center lg:justify-end"
              >
              ...
              {/* Right: Text content (title, paragraph, button) */}
              <motion.div
                initial={{ opacity: 0, x: 40 }}
                whileInView={{ opacity: 1, x: 0 }}
                viewport={{ once: true }}
                transition={{ duration: 1.1 }}
                className="w-full lg:w-1/2 max-w-3xl space-y-10 lg:space-y-12 text-center lg:text-left"
              >
                <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight">
