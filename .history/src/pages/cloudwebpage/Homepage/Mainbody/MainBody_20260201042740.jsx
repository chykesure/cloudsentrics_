    ...
    <section className="relative py-24 md:py-32 px-6 lg:px-12 overflow-hidden bg-gradient-to-b from-[#0a1a3f] to-[#071029] text-white">
      ...
      <div className="relative z-10 max-w-7xl mx-auto space-y-20 md:space-y-32">
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          {/* Left: Image – significantly larger */}
          <motion.div
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          {/* Right: Image – significantly larger + REVOLVING LIGHT on edge */}
          <motion.div
            initial={{ opacity: 0, scale: 0.94, x: 30 }}
            whileInView={{ opacity: 1, scale: 1, x: 0 }}
            viewport={{ once: true }}
          ...
          >
            <div className="relative w-full max-w-2xl lg:max-w-3xl xl:max-w-4xl overflow-hidden rounded-3xl shadow-2xl shadow-cyan-900/50">
              ...
              <div className="absolute inset-0 pointer-events-none">
                <div className="absolute inset-0 rounded-3xl border-2 border-transparent bg-gradient-to-r from-cyan-400 via-blue-500 to-cyan-400 bg-clip-border animate-spin-slow" 
                     style={{
                       backgroundImage: 'conic-gradient(from 0deg, transparent, rgba(6,182,212,0.6), transparent, rgba(6,182,212,0.6), transparent)',
      ...
      {/* Custom CSS for slow revolving animation */}
      <style jsx>{`
        @keyframes spin-slow {
