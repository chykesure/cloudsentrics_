  ...
  return (
    <>
      ...
      <div className="relative bg-gradient-to-b from-[#0a1a3f] to-[#071029] text-white overflow-hidden">
        ...
        {/* Section 3: Build Your Future with Cloud Sentrics – centered layout */}
        <section className="relative py-24 md:py-32 px-6 lg:px-12 bg-white text-[#001F3F]">
          <div className="max-w-7xl mx-auto">
            <div className="flex flex-col lg:flex-row gap-12 lg:gap-16 items-center lg:items-start justify-center">
              {/* Illustration – comes first on mobile, right on desktop */}
              <motion.div
                initial={{ opacity: 0, scale: 0.92, y: 40 }}
                whileInView={{ opacity: 1, scale: 1, y: 0 }}
                viewport={{ once: true }}
                transition={{ duration: 1.3, delay: 0.2 }}
                className="w-full max-w-lg lg:max-w-xl xl:max-w-2xl order-1 lg:order-2 flex justify-center"
              >
                <div className="relative">
                  <img
                    ...
                    className="
                      w-full h-auto object-contain 
                      drop-shadow-[0_30px_80px_rgba(0,31,63,0.35)] 
              ...
              {/* Text + Button + Badges – centered */}
              <motion.div
                initial={{ opacity: 0, x: -60 }}
                whileInView={{ opacity: 1, x: 0 }}
                viewport={{ once: true }}
                transition={{ duration: 1.1 }}
                className="space-y-10 lg:space-y-12 text-center order-2 lg:order-1 w-full max-w-3xl"
              >
                <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight">
                ...
                {/* Compliance badges – centered, straight horizontal line */}
                <div className="mt-12 md:mt-16 flex justify-center">
                  <div className="flex flex-nowrap justify-center gap-8 sm:gap-10 md:gap-12 lg:gap-16">
                    {[
                      ...
                      <div 
                        key={i} 
                        className="flex flex-col items-center text-center flex-shrink-0 min-w-[100px] sm:min-w-[120px] md:min-w-[140px]"
                      >
                        <div className="
                        ...
                        <span className="text-xs sm:text-sm md:text-base text-gray-500 mt-1 text-center leading-tight">
                          {item.full}
                        </span>
                      </div>
                    ))}
