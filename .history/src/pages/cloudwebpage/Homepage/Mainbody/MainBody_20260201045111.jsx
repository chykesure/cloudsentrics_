    ...
    <>
      ...
      <div className="relative bg-gradient-to-b from-[#0a1a3f] to-[#071029] text-white overflow-hidden">
        ...
        <section className="relative py-24 md:py-32 px-6 lg:px-12 bg-white text-[#001F3F]">
          <div className="max-w-7xl mx-auto">
            ...
            "
                ...
                {/* Compliance badges – centered full-width row with equal margins */}
                <div className="mt-12 md:mt-16">
                  <div className="flex justify-center items-start gap-6 sm:gap-10 md:gap-12 lg:gap-16 w-full max-w-5xl mx-auto px-4">
                    {[
                      ...
                      <div
                        key={i}
                        className="flex flex-col items-center text-center flex-shrink-0 min-w-[110px] sm:min-w-[130px] md:min-w-[160px]"
                      >
                        <div className="
        ...
        ">
                        ...
                        <span className="text-xs sm:text-sm md:text-base text-gray-500 mt-1 md:mt-2 text-center leading-tight">
                          {item.full}
                        </span>
                      </div>
                    ))}
