  ...
  return (
    <>
      ...
      <div className="relative bg-gradient-to-b from-[#0a1a3f] to-[#071029] text-white overflow-hidden">
        ...
        {/* Section 3: Build Your Future with Cloud Sentrics – perfectly centered */}
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col items-center gap-12 lg:gap-16">
              ...
              <motion.div
                ...
                className="space-y-10 lg:space-y-12 text-center w-full max-w-4xl"
              >
                <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight">
                ...
                {/* Badges – centered horizontal row with equal spacing */}
                <div className="mt-12 md:mt-16 flex justify-center">
                  <div className="flex flex-nowrap justify-center gap-6 sm:gap-10 md:gap-14 lg:gap-16 xl:gap-20">
                    {[
                      ...
                      <div 
                        key={i} 
                        className="flex flex-col items-center text-center flex-shrink-0 min-w-[100px] sm:min-w-[130px] md:min-w-[150px] lg:min-w-[170px]"
                      >
                        <div className="
