          ...
          <div className="max-w-7xl mx-auto">
            ...
            "
                ...
                <div className="mt-12 md:mt-16 overflow-x-auto">
                  <div className="flex flex-nowrap justify-center lg:justify-start gap-10 md:gap-16 min-w-max">
                    {[
                      ...
                      <div key={i} className="flex flex-col items-center text-center flex-shrink-0 w-28 md:w-36">
                        ...
                        <span className="font-bold text-base md:text-lg whitespace-nowrap">{item.label}</span>
                        <span className="text-xs md:text-sm text-gray-500 mt-1 text-center">{item.full}</span>
                      </div>
                    ))}
                  </div>
                </div>
