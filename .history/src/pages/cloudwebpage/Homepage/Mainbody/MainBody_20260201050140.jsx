  ...
  return (
    <>
      ...
      <div className="relative bg-gradient-to-b from-[#0a1a3f] to-[#071029] text-white overflow-hidden">
        ...
        {/* Section 3: Build Your Future with Cloud Sentrics – side by side on desktop */}
        ...
        <section className="relative py-24 md:py-32 px-6 lg:px-12 bg-white text-[#001F3F]">
          <div className="max-w-7xl mx-auto">
            <div className="flex flex-col lg:flex-row items-center lg:items-start justify-center gap-12 lg:gap-16">
              {/* Left: Text content (title, paragraph, button) */}
              <motion.div
                initial={{ opacity: 0, x: -40 }}
                whileInView={{ opacity: 1, x: 0 }}
                viewport={{ once: true }}
                transition={{ duration: 1.1 }}
                className="w-full lg:w-1/2 max-w-3xl space-y-10 lg:space-y-12 text-center lg:text-left order-2 lg:order-1"
              >
                <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight">
            ...
            "
              ...
              <motion.div
                ...
                className="w-full lg:w-1/2 max-w-xl lg:max-w-2xl flex justify-center lg:justify-start order-1 lg:order-2"
              >
            ...
            {/* Badges row – centered below both columns */}
            <div className="mt-16 md:mt-20 flex justify-center">
              <div className="flex flex-nowrap justify-center gap-6 sm:gap-10 md:gap-14 lg:gap-16 xl:gap-20">
                {[
