          ...
          <div className="space-y-6 md:space-y-8">
            ...
            <div className="flex space-x-5 pt-6">
              {['twitter', 'facebook', 'instagram', 'youtube', 'linkedin'].map((platform) => (
                ...
                >
                  {/* Placeholder - replace with real icons from react-icons */}
          ...
          <div className="space-y-8 md:space-y-10">
            <div className="space-y-6">
              ...
              <div className="space-y-5 text-base md:text-lg">
                <div>
                  <p className="text-[#00d4ff] font-medium flex items-center gap-2">
                    <span>📍</span> 22507 Cappella Village Lane, Katy, TX 77449
                  </p>
                  <p className="text-[#00d4ff] font-medium flex items-center gap-2">
                ...
                <div>
                  <p className="text-[#00d4ff] font-medium flex items-center gap-2">
                    <span>📍</span> No. 6 Aare Avenue, New Bodija Estate, Ibadan, Oyo State-Nigeria.
                  </p>
                  <p className="text-[#00d4ff] font-medium flex items-center gap-2">
