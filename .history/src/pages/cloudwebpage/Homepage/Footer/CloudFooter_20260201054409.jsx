      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-8 lg:px-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-8 lg:gap-12">
          ...
          <div className="space-y-6">
            <h3 className="text-[#00d4ff] text-3xl font-bold tracking-tight leading-tight">
              Cloudsentrics
            </h3>
            ...
            <div className="flex space-x-4 pt-4">
              {/* Twitter / X */}
              <a href="#" className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center text-slate-300 hover:bg-[#00d4ff] hover:text-[#0a1a3f] transition-all duration-300">
          ...
          {/* Center: Navigation */}
          <div className="space-y-6">
            <h4 className="text-[#00d4ff] text-xl font-bold uppercase tracking-wider">Navigation</h4>
          ...
          <div className="space-y-8">
            ...
            {/* Contact Section */}
            <div>
              <h4 className="text-[#00d4ff] text-xl font-bold uppercase tracking-wider mb-6">Contact Us</h4>
              <div className="space-y-6 text-base text-slate-300">
                ...
                <div className="flex items-center gap-3 pt-2">
                  <div className="min-w-[20px] text-[#00d4ff]">
            ...
            <div className="pt-4">
              <h4 className="text-[#00d4ff] text-sm font-bold uppercase tracking-wider mb-4">Get Cloud Sentrics App</h4>
              <div className="flex flex-col space-y-3">
                {/* Google Play Button */}
                <a href="#" className="group flex items-center bg-black border border-slate-700 rounded-lg px-4 py-3 w-[190px] hover:border-[#00d4ff] transition-colors duration-300">
                  ...
                  <div className="flex flex-col">
                    ...
                    <span className="text-sm font-bold text-white leading-tight tracking-wide group-hover:text-[#00d4ff] transition-colors">Google Play</span>
                  </div>
                </a>
                ...
                <a href="#" className="group flex items-center bg-black border border-slate-700 rounded-lg px-4 py-3 w-[190px] hover:border-[#00d4ff] transition-colors duration-300">
                  ...
                  <div className="flex flex-col">
                    ...
                    <span className="text-sm font-bold text-white leading-tight tracking-wide group-hover:text-[#00d4ff] transition-colors">App Store</span>
                  </div>
                </a>
              </div>
            </div>
        ...
        {/* Bottom Bar */}
        <div className="mt-16 pt-8 border-t border-slate-700/50 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-slate-400">
          <p>
