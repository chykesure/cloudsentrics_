...
const CloudHeader = () => {
  ...
  // Shared typography (increased base size for mobile readability)
  const fontStyle = {
    fontFamily: "'Satoshi', system-ui, -apple-system, sans-serif",
    fontWeight: 500,
    fontSize: '16px',           // better default for mobile
    lineHeight: '1.45',
      ...
      <div className="space-y-4 mt-3 px-1">
        {solutionItems.map((item) => (
          <a
            ...
            href={item.href}
            onClick={handleSubmenuClick}
            className="block bg-slate-800/80 backdrop-blur-sm rounded-2xl p-5 hover:bg-slate-700/90 transition border border-slate-700/50"
            style={fontStyle}
          >
            ...
            {item.useCase && (
              <div className="text-slate-300 text-[14.5px] mt-2 leading-relaxed">
                {item.useCase}
              </div>
            )}
          </a>
        ...
        {isOpen && (
          ...
          >
            <div className="flex items-center justify-between p-5 border-b border-slate-800">
              <img src="/cloud.png" className="h-9 w-auto object-contain" />
