        ...
        <table className="w-full border-collapse text-sm">
          <thead>
            <tr className="border-b border-slate-200">
              <th className="text-left pb-3 font-semibold text-slate-800 w-1/2">
                Industries
              </th>
              <th className="text-left pb-3 font-semibold text-slate-800 w-1/2">
                Use Case
          ...
          <tbody className="text-slate-700">
            {solutionItems.map((item) => {
              ...
              // We give each <a> its own hover — no group or row hover
                ...
                <tr key={item.industry}>
                  <td className="py-1.5 pr-4">
                    <a
                      ...
                      className={`block px-3 py-1.5 rounded-md transition-colors duration-150 text-sm
              ${active
                ...
                ${active
                      ...
                      // Keeps vertical spacing consistent without visible text
                      <div className="px-3 py-1.5 text-sm invisible">placeholder</div>
                      // OR simpler: <div className="h-8" /> if you want exact height control
                    )}
                  </td>
                </tr>
              );
