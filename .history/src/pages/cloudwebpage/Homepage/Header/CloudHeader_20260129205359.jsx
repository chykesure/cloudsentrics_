...
const CloudHeader = () => {
  ...
  const navLinks = [
    ...
    },
    {
      label: 'Solution',
      href: '#solution',
      submenu: [{ label: 'View Solutions', href: '#' }], // dummy for chevron logic
    },
    {
      label: 'Resources',
      href: '#resources',
        ...
        <nav className="hidden md:flex items-center space-x-8 relative">
          {navLinks.map((link) => (
            ...
            >
              ...
              {/* Dropdown – only render if submenu exists */}
              {(activeDropdown === link.label || lockedDropdown === link.label) && link.submenu && (
                <AnimatePresence>
                  ...
                  >
                    {link.label === 'Solution' ? (
                      // Enhanced Solutions Table – Fixed hover overlap + row-wide hover
                            ...
                            {solutionItems.map((item) => {
                              ...
                              return (
                                <tr
                                  ...
                                  onMouseEnter={(e) => {
                                    // Ensure whole row gets hover effect (no overlap bleed)
                                    e.currentTarget.style.backgroundColor = isItemActive ? '#04D1FF' : '#07154C';
                                    e.currentTarget.style.color = isItemActive ? 'white' : 'white';
                                  }}
                                  onMouseLeave={(e) => {
                                    // Reset to original state
                                    if (isItemActive) {
                                      e.currentTarget.style.backgroundColor = '#04D1FF';
                                  ...
                                  onClick={() => {
                                    // Click anywhere on row navigates
                                ...
                                >
                                  ...
                                  <td className="py-2 align-middle">
                                    {item.useCase ? (
                                      ...
                                      <span className={`block ${isItemActive ? 'text-white' : 'opacity-50'}`}>
                                        -
                                      </span>
                                    )}
                                  </td>
                      ...
                      // Other menus (Product, Resources, About us)
