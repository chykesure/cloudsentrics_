    ...
    if (!isMobile) {
      return (
        <table className="w-full border-collapse text-sm">
          <thead>
  <tr>
    <th className="text-left pb-2 font-semibold text-slate-800 w-1/2 border-b border-slate-300">
      Industries
    </th>
    <th className="text-left pb-2 font-semibold text-slate-800 w-1/2 border-b border-slate-300">
      Use Case
      ...
      <tr key={item.industry}>
        ...
        <td className="py-2 pr-5">
          <a
            ...
            className={`block px-3 py-1.5 rounded transition-colors duration-150 text-sm font-medium
              ${active 
        ...
        <td className="py-2">
          {item.useCase ? (
            <a
              href={item.href}
              onClick={handleSubmenuClick}
              className={`block px-3 py-1.5 rounded transition-colors duration-150 text-sm
                ${active 
            ...
            // Invisible placeholder to maintain row height & alignment
            <div className="px-3 py-1.5 text-sm invisible">No use case</div>
            // Alternative: <div className="h-8" /> for fixed height control
          )}
        </td>
      </tr>
    );
