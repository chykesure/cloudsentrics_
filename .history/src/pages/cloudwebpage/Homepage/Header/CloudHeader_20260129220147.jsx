...
const CloudHeader = () => {
  ...
  const solutionItems = [
    ...
    { industry: 'Law Firms',  href: '/solutions/law-firms' },
    { industry: 'Manufacturing',  href: '/solutions/manufacturing' },
    { industry: 'Real Estate',  href: '/solutions/real-estate' },
    { industry: 'Financial Institutions',  href: '/solutions/financial' },
    { industry: 'Other Industries',  href: '/solutions/other' },
  ];
                  ...
                  <td className="py-2 pr-4">
                    <a
                      ...
                      className={`block px-2 py-1 rounded transition ${
                        active ? 'bg-[#04D1FF] text-white' : 'hover:bg-[#07154C] hover:text-white'
                      }`}
                    >
                      {item.industry}
                    </a>
