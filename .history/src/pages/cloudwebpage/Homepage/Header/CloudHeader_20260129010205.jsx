                    ...
                    {link.submenu.map((sub, idx) => (
                      <React.Fragment key={sub.label}>
                        <motion.a
                          ...
                          // HOVER STYLE: White background on hover, dark text
                          className={`block px-5 py-3 text-sm transition-colors duration-150 ${
                            currentPath === sub.href
                              ? 'bg-white text-slate-900' // Active Page: White BG
                              : 'text-slate-300 hover:bg-white hover:text-slate-900' // Hover: White BG
                          }`}
                          whileHover={{ x: 4 }}
                        >
                          {sub.label}
