...
const CloudHeader = () => {
  ...
  <thead>
    <tr>
      <th 
        className="text-left pb-3 w-1/2"
        style={{
      ...
      >
        <div className="inline-block border-b border-slate-300 pb-1.5">
          Industries
        </div>
      </th>
        ...
        <tr key={item.industry}>
          <td className="py-2 pr-5">
            <a
              ...
              className={`block px-3 py-2 rounded transition-colors duration-150 text-[15px]
                ${active 
          ...
          <td className="py-2">
            {item.useCase ? (
              ...
              <div className="px-3 py-2 text-[15px] invisible">Placeholder</div>
            )}
          </td>
        </tr>
      );
