...
const CloudHeader = () => {
  ...
  // Solutions Data (special table layout - remains unchanged)
  const solutionItems = [
  ...
  const navLinks = [
    ...
    },
    {
      label: 'Solution',
      href: '#solution',
      submenu: [{ label: 'View Solutions', href: '#' }], // dummy
    },
    {
      label: 'Resources',
      href: '#resources',
            ...
            >
              ...
              <AnimatePresence>
                {(activeDropdown === link.label || lockedDropdown === link.label) && link.submenu && (
                  ...
                  >
                    {link.label === 'Solution' ? (
                      // ── Special wide table for Solutions only ──
                      ...
                      // ── Modern list style used by Product / Resources / About us (this is now the reference style) ──
                        ...
                        {link.submenu.map((sub) => {
                          ...
                          return (
                            <motion.a
                              ...
                              className={`flex items-center justify-between px-5 py-3.5 rounded-lg transition-all duration-200 text-slate-800 ${
                                isActiveSub
                                  ? 'bg-[#07154C] text-white font-medium shadow-sm'
                                  : 'hover:bg-slate-50 hover:text-[#04D1FF]'
                              }`}
                    ...
                    <div className="ml-6 mt-3 space-y-3 border-l-2 border-slate-700 pl-4">
                      {link.submenu.map((sub) => (
                        <motion.a
                          ...
                          className={`block text-base transition-colors px-2 py-1 rounded ${
                            currentPath === sub.href
                              ? 'text-[#04D1FF] font-medium bg-gray-800'
