  ...
  return (
    <>
          ...
          <div className="grid md:grid-cols-2 gap-8 lg:gap-12">
            ...
            <div className="group bg-white rounded-3xl overflow-hidden shadow-2xl hover:shadow-cyan-500/20 transition-all duration-500 hover:-translate-y-2">
              ...
              <div className="p-8 lg:p-10 text-center">
                ...
                {/* CHANGED: Button opens modal instead of linking to /careers */}
                <button
                  type="button"
            ...
            {/* Card 2: Submit CV (unchanged from your last version) */}
      ...
      <dialog
        ...
        open={isNoVacancyModalOpen}
        onClose={() => setIsNoVacancyModalOpen(false)}
      >
        <div className="modal-box bg-white text-slate-900 max-w-md sm:max-w-lg mx-4 rounded-2xl shadow-2xl border border-slate-200 p-8">
          <h3 className="font-bold text-2xl md:text-3xl mb-6 text-center text-slate-800">
            No Open Vacancies Right Now
          </h3>

          <p className="text-center text-slate-600 text-lg md:text-xl leading-relaxed mb-8">
            We're currently not hiring for any positions.<br className="hidden sm:block" />
            Thank you for your interest in Cloud Sentrics!
          </p>

          <p className="text-center text-slate-500 mb-10">
            Please feel free to submit your CV below — we'll keep it on file and reach out when a suitable role opens up.
          </p>

          <div className="modal-action justify-center">
            <button
              className="
                px-10 py-3 text-base md:text-lg font-bold text-white 
                bg-gradient-to-r from-cyan-500 to-blue-600 
                hover:from-cyan-400 hover:to-blue-500 
