...
const CloudSentricsFeatures = () => {
  ...
  const [isNoVacancyModalOpen1, setIsNoVacancyModalOpen1] = useState(false);
  ...
  ──────────────────────────────────────────────── */}
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center mb-20">
            ...
            <div className="space-y-8 animate-fade-in-up">
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-2">
                <button
                  onClick={() => setIsNoVacancyModalOpen1(true)}
                  className="
      ...
      "
            ...
            {/* ────────────────────────────────────────────────
     Simple No Vacancy Modal (popup)
──────────────────────────────────────────────── */}
            {isNoVacancyModalOpen && (
              <div
                className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm px-4"
                onClick={() => setIsNoVacancyModalOpen1(false)}
              >
                <div
                  className="
                ...
                >
                  ...
                  <div className="text-center space-y-6">
                    ...
                    <div className="pt-4">
                      <button
                        onClick={() => {
                          setIsNoVacancyModalOpen1(false);
                          // Optional: scroll to CV submission section
