          ...
          <div className="grid md:grid-cols-2 gap-8 lg:gap-12">
            ...
            <div className="group bg-white rounded-3xl overflow-hidden shadow-2xl hover:shadow-cyan-500/20 transition-all duration-500 hover:-translate-y-2">
              <div className="overflow-hidden h-64 relative">
                {/* Gradient overlay on image for text readability if needed, or just aesthetic */}
              ...
              <div className="p-8 lg:p-10 text-center">
                ...
                <a
                  href="/careers"
                  className="inline-flex items-center justify-center w-full sm:w-auto px-8 py-4 text-base font-bold text-white transition-all duration-200 bg-gradient-to-r from-cyan-500 to-blue-600 rounded-full hover:from-cyan-400 hover:to-blue-500 shadow-lg hover:shadow-cyan-500/30 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-cyan-500"
                >
                  View All Vacancies
            ...
            <div className="group bg-white rounded-3xl overflow-hidden shadow-2xl hover:shadow-indigo-500/20 transition-all duration-500 hover:-translate-y-2">
              <div className="overflow-hidden h-64 relative">
                <div className="absolute inset-0 bg-gradient-to-t from-black/20 to-transparent z-10 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                <img
                  src="/career.png" /* Ideally, use a different image here (e.g., a handshake or recruiter) */
              ...
              <div className="p-8 lg:p-10 text-center">
                ...
                <a
                  href="/contact"
                  className="inline-flex items-center justify-center w-full sm:w-auto px-8 py-4 text-base font-bold text-white transition-all duration-200 bg-slate-900 rounded-full hover:bg-slate-800 shadow-lg hover:shadow-slate-900/30 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-slate-900"
                >
                  Submit Your CV
                  <svg className="w-5 h-5 ml-2 -mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path></svg>
                </a>
              </div>
            </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center mb-20">
            ...
            <div className="space-y-8 animate-fade-in-up">
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-2">
                <a
                  href="/careers"
                  className="inline-flex justify-center items-center px-8 py-4 text-base font-bold text-white transition-all duration-200 bg-gradient-to-r from-cyan-500 to-blue-600 rounded-full hover:from-cyan-400 hover:to-blue-500 shadow-lg hover:shadow-cyan-500/30 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-cyan-500"
                >
                  View Open Roles
                </a>
              </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <div className="bg-white rounded-2xl p-8 shadow-lg border border-zinc-100 hover:shadow-2xl transition-shadow duration-300 relative">
                ...
                <div className="flex items-center border-t border-zinc-100 pt-6">
                  ...
                  <div className="ml-4">
                    <p className="text-zinc-900 font-bold text-lg">Fatima Yusuf</p>
                    <p className="text-blue-600 text-sm font-medium">Cloud Engineer</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-2xl p-8 shadow-lg border border-zinc-100 hover:shadow-2xl transition-shadow duration-300 relative">
                ...
                <div className="flex items-center border-t border-zinc-100 pt-6">
                  ...
                  <div className="ml-4">
                    <p className="text-zinc-900 font-bold text-lg">Olusegun Adebayo</p>
                    <p className="text-indigo-600 text-sm font-medium">Security Analyst</p>
                  </div>
                </div>
              </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            ...
            <div className="space-y-8">
              ...
              <div className="space-y-4 pt-6">
                <div className="flex items-center p-4 bg-white rounded-2xl shadow-sm border border-zinc-100">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-zinc-900 font-medium">recruitment@cloudsentrics.com</p>
                  </div>
                </div>
            ...
            <div className="bg-white p-8 lg:p-10 rounded-3xl shadow-xl border border-zinc-100" id="pricing-plans">
