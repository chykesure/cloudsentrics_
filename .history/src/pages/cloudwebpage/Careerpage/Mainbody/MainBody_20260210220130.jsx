...
const handleViewRolesClick = (e: React.MouseEvent) => {
  e.preventDefault();           // prevent navigation if you want to show modal first
  setShowNoVacancyModal(true);  // or navigate + show toast/modal on /careers
};
      ...
      <section className="bg-white text-zinc-900 py-16 md:py-24 lg:py-32 overflow-hidden">
        <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12 xl:px-16">
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center mb-20">
            ...
            <div className="space-y-8 animate-fade-in-up">
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-2">
                <button
                  ...
                  className="inline-flex justify-center items-center px-8 py-4 text-base font-bold text-white transition-all duration-200 bg-gradient-to-r from-cyan-500 to-blue-600 rounded-full hover:from-cyan-400 hover:to-blue-500 shadow-lg hover:shadow-cyan-500/30 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-cyan-500 active:scale-95"
                >
                  View Open Roles
                </button>
              </div>
            ...
            {/* Simple No Vacancy Modal */}
            {showNoVacancyModal && (
              <div
                className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4"
                onClick={() => setShowNoVacancyModal(false)}
              >
                <div
                  className="bg-white rounded-2xl shadow-2xl max-w-md w-full p-8 relative scale-100 animate-in fade-in zoom-in-95 duration-300"
                  onClick={e => e.stopPropagation()}
                >
                  <button
                  ...
                  <div className="text-center space-y-5">
                    ...
                    <p className="text-gray-600">
                      We're not actively hiring for specific positions at the moment, but we're always looking for great talent!
                    </p>

                    <p className="text-gray-500 text-sm">
                      We'd love to keep your profile in our talent pool for future opportunities.
                    </p>

                    <div className="pt-4">
                      <a
                        href="#submit-cv" // or "/careers#submit-cv" or wherever your CV form is
                        onClick={() => setShowNoVacancyModal(false)}
                        className="inline-flex items-center px-8 py-3 bg-gradient-to-r from-cyan-500 to-blue-600 text-white font-medium rounded-full hover:from-cyan-400 hover:to-blue-500 shadow-md hover:shadow-lg transition-all"
                      >
                        Submit Your CV
                      </a>
                    </div>
