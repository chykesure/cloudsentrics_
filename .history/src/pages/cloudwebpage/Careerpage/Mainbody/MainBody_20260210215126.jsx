              ...
              <div className="space-y-4 pt-6">
                <div className="flex items-center p-4 bg-white rounded-2xl shadow-sm border border-zinc-100">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-zinc-900 font-medium">info@cloudsentrics.org</p>
                  </div>
                </div>
                ...
                <div className="flex items-center p-4 bg-white rounded-2xl shadow-sm border border-zinc-100">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-zinc-900 font-medium">+1 346-580-6298</p>
                  </div>
                </div>
                ...
                <div className="flex items-center p-4 bg-white rounded-2xl shadow-sm border border-zinc-100">
                  <div className="w-12 h-12 rounded-full bg-blue-50 flex items-center justify-center text-blue-600 shrink-0">
                    <svg
                      className="w-5 h-5"  // slightly larger than phone icon for balance
                      fill="currentColor"
                      viewBox="0 0 16 16"
                    >
                  ...
                  <div className="ml-4">
                    <p className="text-sm font-semibold text-zinc-500 uppercase tracking-wider">Call Us</p>
                    <p className="text-zinc-900 font-medium">+234 705 663 9388</p>
                  </div>
                </div>
                ...
                <div className="flex items-center p-4 bg-white rounded-2xl shadow-sm border border-zinc-100">
                  ...
                  <div className="ml-4">
                    <p className="text-sm font-semibold text-zinc-500 uppercase tracking-wider">Call Us</p>
                    <p className="text-zinc-900 font-medium">+234 814 457 3546</p>
                  </div>
                </div>
              </div>
            </div>
