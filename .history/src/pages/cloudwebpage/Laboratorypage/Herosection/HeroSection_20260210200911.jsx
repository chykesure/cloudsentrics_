...
const EducationHero = () => {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-slate-950 text-white">
      {/* Background – now guaranteed to fill */}
      <div className="absolute inset-0 z-0">
        <img
          src="/lab3.png"
          alt="Students collaborating in classroom"
          className="absolute inset-0 w-full h-full object-cover object-center brightness-[1.78] contrast-[0.78] saturate-[1.92]"
        />
        {/* Overlays */}
      ...
      {/* Content */}
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 md:px-8 lg:px-10 py-16 md:py-20 lg:py-24">
