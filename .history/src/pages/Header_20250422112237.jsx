...
const Header = () => {
  ...
  const menuItems = [
    ...
    { label: "Blog", path: "/blog" },
    {
      label: "Services",
      options: [
        { label: "Cloud Services", path: "/services/cloud", icon: <Cloud size={20} /> },
        { label: "Application Security", path: "/services/security", icon: <ShieldCheck size={20} /> },
        { label: "Server Management", path: "/services/server", icon: <Server size={20} /> },
      ]
    },
