...
import CourseForm from './CourseForm'; // Assuming CourseForm is in the same directory

// Load your stripe key
                ...
                {step === 2 && (
                    <>
                        ...
                        {formData.paymentMethod === 'one-time' && (
                            <div className="mb-6">
                                <label className="block text-sm font-medium text-gray-600 mb-2">Amount (USD)</label>
                                <input
                                    type="number"
                                    name="amount"
                                    value={3000} // One-time payment fixed amount
                                    readOnly
                                    className="w-full p-3 border border-gray-300 rounded-md"
                        ...
                        <button
                            ...
                            disabled={!isAmountValid()} // Disable button if the amount is not valid
                        >
                            Next
                        </button>
                    </>
