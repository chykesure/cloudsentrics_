...
<header className="flex items-center justify-between px-6 py-4 bg-white shadow-md fixed top-0 left-0 w-full z-50"></header>

    return (
        <header className="flex items-center justify-center px-6 py-4 bg-white shadow-md fixed top-0 left-0 w-full z-50">
