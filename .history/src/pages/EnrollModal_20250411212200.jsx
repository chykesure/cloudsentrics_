...
import { FaArrowLeft } from 'react-icons/fa';  // Importing an arrow-back icon
...
const EnrollForm = ({ onClose }) => {
    ...
    const handleGoBack = () => setStep(step - 1); // Handle going back
    ...
    const handlePaymentSubmit = async (e) => {
        ...
        console.log("Preparing to send payment intent request...");
