...
const CourseForm = ({ onClose }) => {
    const [step, setStep] = useState(0); // Start from Token Step
    ...
    const handleVerifyToken = async () => {
        if (!formData.email || !formData.token) {
            alert("Please enter your email and token.");
            return;
        }
        ...
        try {
            ...
            alert("❌ Something went wrong while verifying token.");
        }
    };
            ...
            <div className="bg-white w-full max-w-3xl p-8 rounded-lg shadow-xl relative overflow-auto max-h-[90vh]">
                ...
                {step === 0 && (
                    <>
                        ...
                        <button
                            className="w-full bg- text-white py-3 rounded-md hover:bg-blue-700"
