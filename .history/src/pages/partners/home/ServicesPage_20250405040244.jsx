        ...
        <section className="px-6 py-12 bg-gray-100">
                ...
                {services.map((service, index) => (
                    ...
                    >
                        ...
                        <div className="p-6 text-center">
                            ...
                            <button className="mt-4 px-6 py-2 bg-[#1e4272] text-white rounded-lg hover:bg-green-600 transition">
            ...
            <div className="mt-12 flex flex-col md:flex-row justify-between items-center bg-white p-8 rounded-lg shadow-lg">
                <div className="md:w-1/2">
                    <h2 className="text-3xl font-bold text-[#1e4272]">
                    ...
                    <button className="mt-4 px-6 py-2 bg-[bg-[#1e4272]] text-white rounded-lg hover:bg-[purple-900] transition">
                        More about Us →
                    </button>
                </div>
