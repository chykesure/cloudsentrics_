...
const primaryColor = "#007BFF"; // You can replace this with your primary color

const WhyChooseCloudSentrics = () => {
  return (
    <section className="px-4 sm:px-6 md:px-8 lg:px-16 py-16 bg-white min-h-screen">
      ...
      <p className="text-lg sm:text-xl lg:text-2xl text-gray-700 text-center mt-4 sm:mt-6 max-w-4xl mx-auto leading-relaxed">
        Explore how Cloud Sentrics transforms industries with innovative cloud solutions.
      </p>
...
export default WhyChooseCloudSentrics;
