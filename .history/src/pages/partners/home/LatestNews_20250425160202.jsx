...
With enrollment now open for Batch 7 starting on May 24th, 2025, Cloud Sentrics is inviting new students to embark on their transformative tech journey.`
  ...
  {
    id: 2,
    title: "Meet the Visionary - Oluwadamilare Odo, Founder of Cloud Sentrics",
    image: ai_conversation,
    description: "From Personal Struggles to a Mission to Empower",
    highlight: true,
    content: `Oluwadamilare Odo didn’t have a roadmap when he started his journey into Cloud DevSecOps. He learned on the job, navigating complex systems while trying to build a meaningful career in the tech industry. It was a journey filled with late nights, trial and error, and moments of overwhelming self-doubt.
    ...
    <section className="bg-gray-100 py-12 px-4 relative">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="bg-white p-6 shadow-lg rounded-lg flex justify-center items-center">
          <img
            src={newz}
            alt="Cloud Sentrics Integration"
