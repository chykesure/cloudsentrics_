            ...
            <div className="lg:w-2/3 bg-white p-8 rounded-lg shadow-lg">
                ...
                <ul className="mt-4 space-y-3 text-gray-700">
                    {[
                        ...
                        "Security Built-In
From endpoint to enterprise-wide defense, we embed robust security across your entire cloud ecosystem—protecting users, devices, and data at every touchpoint.
",
