        ...
        <section className="px-6 py-8 bg-gray-100 flex flex-col lg:flex-row gap-8 mt-[-60px]">
            ...
            <div className="lg:w-2/3 bg-white p-8 rounded-lg shadow-lg">
                ...
                <ul className="mt-4 space-y-3 text-gray-700">
                    {[
                        "Strategic Cloud AssessmentWe'll evaluate your cloud readiness and align the right strategy whether it’s public cloud, hybrid, or on-premise infrastructure.",
                        "Intelligent Architecture & OptimizationOur experts optimize your cloud platform using IaaS, PaaS, and SaaS to extend your infrastructure, enhance scalability, and improve operational performance.
",
