...
const FormsPage = () => {
    ...
    const form = useRef();  // UseRef to handle the form reference
    ...
    const handleSubmit = (e) => {
        ...
        emailjs
            .sendForm(
                ...
                'template_vf7xpmm', // Your template ID
                form.current, // The form reference
                'Fh76KR5FuYbqm1weT' // Your user ID
            )
            .then(
                (result) => {
        ...
        <section className="px-6 py-12 bg-gray-100">
            ...
            <div className="w-full px-4 md:px-8 grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="bg-white p-10 shadow-xl rounded-lg text-black w-full">
                    ...
                    <form ref={form} onSubmit={handleSubmit} className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-6 col-span-3">
                        {[ 
                        ...
                        <div className="flex flex-col w-full">
                            ...
                            <select
                                id="services"
                                name="services"  // Add the 'name' attribute
                                required
                                className="w-full p-4 border rounded-md text-gray-800 shadow-md focus:ring-2 focus:ring-purple-500 transition-all"
                            >
                        ...
                        <div className="col-span-1 md:col-span-2 flex items-center">
                            <input type="checkbox" id="marketing-emails" name="marketing-emails" className="mr-2" />
                        ...
                        <div className="col-span-1 md:col-span-2">
                            <button className="w-full bg-[#1e4272] text-white p-3 rounded-lg font-semibold hover:bg-purple-900 transition">
                                Submit
                            </button>
                        </div>
