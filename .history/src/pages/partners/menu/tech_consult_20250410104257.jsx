            ...
            <aside className="lg:w-1/3 space-y-6">
                ...
                <div className="bg-white p-6 rounded-lg shadow-lg">
                    ...
                    <ul className="mt-4 space-y-2 text-gray-700">
                        <li>Digital Transformation Strategy Tailored roadmaps to accelerate business modernization and innovation.</li>
                        <li>Cloud & Data Center Infrastructure Scalable, secure, and efficient cloud and on-prem solutions to support your IT needs.</li>
                        <li>AI & Machine Learning Integration Intelligent systems that enhance automation, analytics, and decision-making.</li>
                        <li>Cybersecurity & Risk Management Proactive protection frameworks to secure data, systems, and operations.</li>
                        <li>IT Modernization & Optimization <b></b> Streamlined technology ecosystems that boost performance and reduce costs.</li>
                    </ul>
                </div>
