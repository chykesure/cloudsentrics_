                        ...
                        <div className="bg-white p-6 rounded-lg shadow-lg border-gray-200 hover:scale-105 hover:shadow-xl flex-shrink-0 w-full">
                            ...
                            <ul className="mt-4 space-y-3 text-gray-700">
                                {[
                                    ...
                                    "Effortless Integration with Your Existing StackOur solutions blend seamlessly with your infrastructure, minimizing disruption while maximizing performance.
",
