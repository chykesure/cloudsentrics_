        ...
        <section className="px-6 py-8 bg-gray-100 flex flex-col lg:flex-row gap-8 mt-[-60px]">
            ...
            <div className="lg:w-2/3 bg-white p-8 rounded-lg shadow-lg">
                ...
                <p className="mt-4 font-semibold text-gray-700">
                    At Cloud Sentrics, we help organizations adopt a cloud-first mindset—enabling seamless digital transformation no matter where you are on your journey. <br/><br/>
