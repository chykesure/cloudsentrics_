                        ...
                        <div className="bg-white p-6 rounded-lg shadow-lg border-gray-200 hover:scale-105 hover:shadow-xl flex-shrink-0 w-full">
                            ...
                            <ul className="mt-4 space-y-3 text-gray-700">
                                {[
                                    ...
                                    "AI Training
Equip your teams with the skills they need through hands-on AI training programs designed for professionals, developers, and business leaders ready to lead with AI."
                                ].map((service, index) => (
