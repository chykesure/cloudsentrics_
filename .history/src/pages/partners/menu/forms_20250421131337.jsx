...
const FormsPage = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // Reset the button to "Submit" after successful submission
            ...
            Swal.fire({
                icon: 'error',
                title: 'Oops...',
                text: `Something went wrong: ${error.message}`, // Show detailed error message
                confirmButtonText: 'Try Again',
            });

            // Reset the button to "Submit" after an error
            setIsProcessing(false);
        }
    };
                ...
                <div className="bg-white p-10 shadow-xl rounded-lg text-black w-full">
                    ...
                    <form className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-6 col-span-3" onSubmit={handleSubmit}>
                        ...
                        <div className="col-span-1 md:col-span-2">
                            ...
                            >
                                {isProcessing ? 'Processing...' : 'Submit'} {/* Change text when processing */}
                            </button>
                        </div>
