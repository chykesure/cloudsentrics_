            ...
            <section className="bg-[#f9f9f9] px-6 md:px-16 py-16 lg:py-24 grid grid-cols-1 lg:grid-cols-3 gap-12">
                ...
                <div className="lg:col-span-2 animate__animated animate__fadeIn flex-shrink-0 space-y-6">
                    ...
                    <div className="flex justify-center lg:justify-start mt-8">
                        <a
                            href="#"
                            className="bg-[] text-white text-center py-4 px-8 rounded-lg font-semibold text-lg shadow-md hover:bg-purple-800 hover:scale-105 transition duration-300 ease-in-out transform hover:translate-y-1 w-full md:w-auto"
                        >
