                        ...
                        <div className="bg-white p-6 rounded-lg shadow-lg border-gray-200 hover:scale-105 hover:shadow-xl flex-shrink-0 w-full">
                            ...
                            <ul className="mt-4 space-y-3 text-gray-700">
                                {[
                                    ...
                                    "Conversational AI
Enhance customer engagement with intelligent, human-like virtual assistants that scale across platforms integrated with your cloud environment for 24/7 efficiency.",
                                    "AI Ops",
