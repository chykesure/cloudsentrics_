    ...
    const services = [
        {
            title: "Cloud",
            description:
                "Empower agility, speed, and growth.
Leverage secure, scalable cloud solutions to modernize your business and accelerate transformation with Cloud Sentrics.",
            image: cloud_service,
        },
        {
            title: "Application Transformation",
            description:
                "Evolve your application to maintain a competitive edge",
            image: App_trans,
        },
        {
            title: "Security",
