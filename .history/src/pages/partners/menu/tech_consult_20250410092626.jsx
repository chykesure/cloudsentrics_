        ...
        <section className="px-6 py-8 bg-gray-100 flex flex-col lg:flex-row gap-8 mt-[-60px]">
            ...
            <aside className="lg:w-1/3 space-y-6">
                ...
                <div className="bg-white p-6 rounded-lg shadow-lg">
                    ...
                    <p className="mt-4 text-gray-60">Our suite of aligned services is designed to drive enterprise growth, operational excellence, and sustainable innovation. We support organizations in navigating the complexities of digital transformation through:</p>
