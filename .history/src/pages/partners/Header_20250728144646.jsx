...
const Header = () => {
  ...
  return (
    <header className="bg-[#1e4272] text-white flex items-center justify-between px-4 sm:px-6 py-4 fixed top-0 left-0 w-full z-50 shadow-md relative">
      {/* Logo */}
      <div className="flex items-center gap-4">
        <Link to="/">
          <img
            src={logo}
            alt="Logo"
            className="h-14 w-14 sm:h-16 sm:w-16 object-cover rounded-full border-2 border-white shadow-md"
          />
        </Link>
      </div>
      ...
      <motion.div
        className="hidden lg:flex absolute left-1/2 transform -translate-x-1/2 items-center space-x-6 lg:space-x-10 text-lg lg:text-xl font-semibold tracking-wide h-full"
