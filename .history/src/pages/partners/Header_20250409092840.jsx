  ...
  return (
    <header className="bg-[#1e4272] text-white flex items-center justify-between px-6 py-4 fixed top-0 left-0 w-full z-50 shadow-md">
      ...
      <div className="flex items-center gap-3 text-sm">
        {/* Countdown content here if needed */}
      </div>

      {/* Updated Desktop Navigation with Framer Motion and React Router */}
      <motion.div
        className="hidden lg:flex flex-grow justify-center items-center space-x-6 lg:space-x-10 text-lg lg:text-xl font-semibold tracking-wide h-full"
      ...
      >
        {[
          ...
          { label: "ABOUT CLOUD", path: "/about-cloudsentrics" },
