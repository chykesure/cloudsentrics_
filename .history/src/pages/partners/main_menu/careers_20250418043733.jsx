...
const aibg = "/assets/ai.jpg"; // Replace with your background image path
        ...
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="md:hidden">
            <button onClick={() => setMobileNavOpen(!mobileNavOpen)}>
              {mobileNavOpen ? (
                <svg className="w-6 h-6 text-gray-700 bg-black ">
                  <path
                    strokeLinecap="round"
                ...
                <svg className="w-6 h-6 text-gray-700 bg-black text-white">
                  <path
                    strokeLinecap="round"
                    strokeLinejoin="round"
                    strokeWidth={2}
