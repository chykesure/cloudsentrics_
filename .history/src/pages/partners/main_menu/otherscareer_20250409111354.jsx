...
const CareerPage = () => {
    ...
    <motion.div className="bg-white shadow-md p-5 rounded space-y-2 border-t-4 border-purple-500" initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }}>
    ...
    <motion.div className="bg-white shadow-md p-5 rounded space-y-2 border-t-4 border-blue-500" initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.45 }}>
        <div className="flex items-center gap-2">
    ...
    <motion.div className="bg-white shadow-md p-5 rounded space-y-2 border-t-4 border-green-500" initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
        <div className="flex items-center gap-2">
    ...
    <motion.div className="bg-white shadow-md p-5 rounded space-y-2 border-t-4 border-yellow-500" initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.55 }}>
        <div className="flex items-center gap-2">
    ...
    <motion.div className="bg-white shadow-md p-5 rounded space-y-2 border-t-4 border-pink-500" initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
        <div className="flex items-center gap-2">
