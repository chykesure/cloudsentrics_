...
const ContactMap = () => {
  return (
    <div className="bg-[#f9fafb] pt-16 px-4 sm:px-6 lg:px-20">
      ...
      {/* Office Info Card */}
      <div className="bg-white rounded-lg shadow-md p-6 mb-16 max-w-3xl mx-auto">
        ...
        <p className="text-gray-800 font-medium mb-2">
          Call:{" "}
          <a href="tel:+13463998985" className="text-blue-600">
            +1 346-399-8985
          </a>
        </p>
      ...
      {/* Bottom Info Boxes */}
      <div className="py-16 px-4 sm:px-6 lg:px-20 bg-[#f9fafb] grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
