...
const Careers = () => {
    return (
        <div className="min-h-screen bg-[#0d1b2a] text-white">
            ...
            <section className="bg-white px-6 md:px-16 py-16 lg:py-24 space-y-12">
      {/* Header Section */}
      <motion.div
      ...
      >
        <p className="text-sm text-gray-600">Find your next role with us</p>
        <h1 className="text-3xl md:text-4xl font-semibold text-gray-900">
          Build your future with Bell
        </h1>
        <img
          src="/assets/bell-logo.png" // Replace with actual logo path
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
        ...
        >
          <img
            src="/assets/group-smiling.jpg" // Replace with your actual image
        ...
        >
          <img
            src="/assets/two-people-talking.jpg" // Replace with your actual image
