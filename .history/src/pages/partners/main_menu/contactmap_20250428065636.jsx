...
const ContactMap = () => {
    return (
        <div className="bg-[#f9fafb] pt-16 px-4 sm:px-6 lg:px-12">
            ...
            <div className="grid gap-6 mb-16 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4">
  {/* Houston Office */}
  <div className="bg-white rounded-xl shadow-lg p-8 transition-transform transform hover:scale-105">
