                ...
                <div className="grid md:grid-cols-2 gap-12 lg:gap-20">
                    ...
                    <div className="bg-white shadow-xl rounded-lg p-10 md:p-16 lg:p-20 flex flex-col items-stretch transition-all duration-300 hover:shadow-2xl hover:scale-105">
                        ...
                        <div className="grid gap-6 mt-8 text-gray-800 text-lg">
                            {[
                                { title: "Cloud Migration Skills", description: "Transition workloads to AWS smoothly." },
                                { title: "Cloud Security Expertise", description: "Ensure top-tier protection for your cloud infrastructure." },
                                { title: "DevSecOps Knowledge", description: "Automate security within CI/CD pipelines." },
