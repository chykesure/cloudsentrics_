  ...
  return (
    <div className="min-h-screen bg-[#0d1b2a] text-white">
      ...
      <header className="relative bg-white shadow-lg w-full z-30">
        <div className="flex items-center justify-between px-6 md:px-12 py-6 max-w-[1200px] mx-auto h-28 md:h-32 lg:h-40">
          {/* Logo */}
          ...
          {/* Desktop Navigation */}
          <motion.nav
            className="hidden md:flex flex-grow justify-center items-center space-x-6 lg:space-x-10 text-lg md:text-xl font-bold text-[#1e1e1e] tracking-wide"
      ...
      {/* Footer */}
      <footer className="py-8 bg-gray-100 w-full">
        <Footer />
      </footer>
    </div>
  );
