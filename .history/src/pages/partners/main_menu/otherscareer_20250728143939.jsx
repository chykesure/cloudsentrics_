...
const CareerPage = () => {
    return (
        <div className="bg-white text-gray-800 px-4 md:px-12 py-12 space-y-16">
            ...
            {/* Section 2: Employee Testimonial (Side-by-Side) */}
            <section className="bg-gray-100 rounded-xl p-6 md:p-10 grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                <motion.div
                    className="space-y-6"
                ...
                >
                    ...
                    <div className="text-sm text-gray-500">01 / 08</div>
                </motion.div>

                <motion.div
                    className="w-full h-72 md:h-[400px] rounded-xl overflow-hidden shadow-md"
                    initial={{ opacity: 0, x: 30 }}
                    whileInView={{ opacity: 1, x: 0 }}
                    transition={{ duration: 0.6 }}
                >
