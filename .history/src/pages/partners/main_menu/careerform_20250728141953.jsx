...
const CareerForm = () => {
  ...
  return (
    <section className="bg-gray-100 text-gray-800 py-12">
      <div className="bg-white shadow-xl rounded-lg max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 overflow-hidden">
        <form
          onSubmit={handleSubmit}
          className="md:col-span-2 p-6 md:p-10 space-y-6"
        >
