...
// Testimonial image
const testimonialImg = "/assets/testimonial-woman.jpg"; // replace with your own

const CareerPage = () => {
  return (
    <div className="bg-white text-gray-800 px-4 md:px-12 py-12 space-y-20">
      {/* Section 1: Working at Bell */}
      <section className="space-y-6">
        <h2 className="text-3xl font-bold text-green-800 border-b-2 border-green-700 w-fit">Working at Bell</h2>
        <div className="grid md:grid-cols-2 gap-8">
          <div className="space-y-4">
            <p>
              At Bell Integration, we’re passionate about taking care of the people who have made the decision to join our team.
            </p>
            <p>
          ...
          <div className="space-y-4">
            ...
            <p>
              Be well @ Bell is our commitment to the wellbeing of our employees, which is why you’ll find a variety of roles offering hybrid, remote or office-based working arrangements across our organisation.
            </p>
            <p>
              We recognise that our greatest asset is our people – it’s what our success is built on and it’s why we’re working hard to ensure that we provide employee experience for everyone who has chosen to take the next step of their career with us. If you’d like to help shape the future here at Bell and be part of something exciting, why not join us for the journey?
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-gray-100 rounded-lg p-6 md:p-10 flex flex-col md:flex-row gap-6 items-center">
        <motion.div
        ...
        >
          <blockquote className="text-lg italic font-medium text-gray-700">
            "I have learned so much since starting at Bell and everyone I work with are so friendly and supportive to my career goals. It’s been such a positive experience since I started a year ago"!
          </blockquote>
          <p className="font-semibold text-sm text-gray-900">
            Catherine Quinn <br />
            <span className="text-gray-600">PMO Support Administrator</span>
          </p>
          <div className="text-sm text-gray-600">01 / 08</div>
        </motion.div>
        <motion.div
          className="w-full md:w-60 h-60 rounded overflow-hidden shadow-md"
          initial={{ opacity: 0, x: 30 }}
          whileInView={{ opacity: 1, x: 0 }}
          transition={{ duration: 0.6 }}
        >
