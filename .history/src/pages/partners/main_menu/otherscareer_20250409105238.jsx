        ...
        <div className="bg-white text-gray-800 px-4 md:px-12 py-12 space-y-20">
            ...
            <section>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 text-sm text-gray-800">
                    {/* Each motion box */}
                    <motion.div
                        className="bg-white shadow-md p-5 rounded space-y-2 border-t-4 border-purple-500"
                        initial={{ opacity: 0, y: 20 }}
                        whileInView={{ opacity: 1, y: 0 }}
                    ...
                    <motion.div
                        className="bg-white shadow-md p-5 rounded space-y-2 border-t-4 border-blue-500"
                        initial={{ opacity: 0, y: 20 }}
                        whileInView={{ opacity: 1, y: 0 }}
                    ...
                    <motion.div
                        className="bg-white shadow-md p-5 rounded space-y-2 border-t-4 border-green-500"
                        initial={{ opacity: 0, y: 20 }}
                        whileInView={{ opacity: 1, y: 0 }}
                        transition={{ duration: 0.5 }}
                    >
                    ...
                    <motion.div
                        className="bg-white shadow-md p-5 rounded space-y-2 border-t-4 border-yellow-500"
                        initial={{ opacity: 0, y: 20 }}
                        whileInView={{ opacity: 1, y: 0 }}
                    ...
                    <motion.div
                        className="bg-white shadow-md p-5 rounded space-y-2 border-t-4 border-pink-500"
                        initial={{ opacity: 0, y: 20 }}
                        whileInView={{ opacity: 1, y: 0 }}
                        transition={{ duration: 0.6 }}
                    >
