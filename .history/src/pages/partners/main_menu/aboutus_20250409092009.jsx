                ...
                <div className="flex-1 space-y-6">
                    ...
                    <div className="bg-white p-6 shadow rounded-xl space-y-4">
                        <p className="text-lg font-semibold text-gray-800">
                            For over 25 years, Cloud ’s market-leading technology consultation and managed services have enabled organisations to transform their IT capabilities and elevate their business productivity and cost efficiency.
                        </p>
