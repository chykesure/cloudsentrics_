...
const allArticles = [
  {
    title: "Bell Integration & Pure Storage Unveil AI Innovation",
    image: ai_trainning,
    description: "Bell Integration and Pure Storage showcase ‘Nature in the Age of AI’",
    highlight: true,
  },
  {
    title: "Bell Integration CEO On Procurement Spin Off",
  ...
  {
    title: "IT Channel Oxygen - Bell placed 6th in UK top 250",
    bgColor: "bg-white text-purple-900",
  },
  {
    title: "Bell Integration breaks £1 Billion Revenue Barrier",
    bgColor: "bg-purple-900 text-white",
  },
  {
    title: "Kore.ai and Bell Integration to Deliver AI Solutions",
    bgColor: "bg-blue-700 text-white",
  },
  {
    title: "Building Stronger Futures, One Game at a Time",
    bgColor: "bg-purple-900 text-white",
  },
  {
    title: "Bell Announces Partnership With Starburst",
    image: iot_data,
  },
  {
    title: "Bell Partners With NICE To Be The Preferred Global Partner",
    image: iot_solution,
  },
  {
    title: "Portsmouth Cricket Club & Bell Integration Team Up",
    image: cloudchip,
  },
  {
  ...
  {
    title: "Dell Technologies 2024 Gold Partner Award",
    image: data,
  },
  {
    title: "E2E Tech 100",
...
const NewsArticles = () => {
  ...
  return (
    <section className="px-4 py-8 bg-white text-">
      {/* Filter Row */}
