                ...
                <div className="flex-1 space-y-6">
                    ...
                    <div className="bg-white p-6 shadow rounded-xl space-y-4">
                        <p className="text-lg font-semibold text-gray-800">
                            Headquartered in the US and with offices and operations across the globe, we work with local and international customers to streamline every aspect of their IT management strategies to maximise efficiencies and increase their ROI, year on year.
                        </p>
                        <p className="font-semibold text-gray-800">
                            Head-quartered in the US and employing over 1000 people across the globe.
                        </p>
