...
const CareerPage = () => {
    return (
        <div className="bg-white text-gray-800 px-4 md:px-12 py-12 space-y-20">
            {/* Section 1: Working at Clou */}
            <section className="space-y-6">
                <h2 className="text-3xl font-bold text-green-800 border-b-2 border-green-700 w-fit">Working at Clou</h2>
                <div className="grid md:grid-cols-2 gap-8">
                    <div className="space-y-4">
                        <p>
                            At Clou Integration, we’re passionate about taking care of the people who have made the decision to join our team.
                        </p>
                        <p>
                    ...
                    <div className="space-y-4">
                        ...
                        <p>
                            Be well @ Clou is our commitment to the wellbeing of our employees, which is why you’ll find a variety of roles offering hybrid, remote or office-based working arrangements across our organisation.
                        </p>
                        <p>
                            We recognise that our greatest asset is our people – it’s what our success is built on and it’s why we’re working hard to ensure that we provide employee experience for everyone who has chosen to take the next step of their career with us. If you’d like to help shape the future here at Clou and be part of something exciting, why not join us for the journey?
                        </p>
                    </div>
                </div>
            </section>
            ...
            <section className="bg-gray-100 rounded-lg p-6 md:p-10 grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
                ...
                >
                    <blockquote className="text-xl italic font-medium text-gray-700">
                        "I have learned so much since starting at Clou and everyone I work with are so friendly and supportive to my career goals. It’s been such a positive experience since I started a year ago!"
                    </blockquote>
