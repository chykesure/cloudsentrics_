...
const Careers = () => {
  ...
  return (
    <div className="bg-white text-gray-800">
      ...
      {/* Hero Section */}
      <section className="pt-36 pb-20 bg-[#f9fafb] px-6 text-center">
        <motion.div
      ...
      {/* Career Cards */}
      <section className="px-6 md:px-12 py-16 bg-white grid grid-cols-1 md:grid-cols-2 gap-10 max-w-7xl mx-auto">
        {/* Latest Roles Card */}
        <motion.div
      ...
      {/* Form Section */}
      <section ref={careerFormRef} className="py-16 bg-[#f3f4f6] px-6 md:px-12">
        <div className="max-w-6xl mx-auto bg-white shadow-xl rounded-2xl p-6 md:p-10">
          <h2 className="text-3xl font-bold text-center mb-6 text-[#1e4272]">Submit Your Application</h2>
          <CareerForm />
        </div>
      </section>
