                    ...
                    <div className="absolute left-0 flex items-center w-auto h-full">
                        <Link to="/PartnerPage">
                            <img
                                ...
                                className="h-20 md:h-28 w-auto ml-9 transition-all duration-300"
                            />
                        </Link>
                    </div>
                ...
                <div className="flex-1 space-y-6">
                    ...
                    <div className="bg-white p-6 shadow rounded-xl space-y-4">
                        <p className="text-lg font-semibold text-gray-800">
                            For over 25 years, Cloud Sentrics’s market-leading technology consultation and managed services have enabled organisations to transform their IT capabilities and elevate their business productivity and cost efficiency.
                        </p>
