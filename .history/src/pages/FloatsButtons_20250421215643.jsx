            ...
            if (response.ok) {
                setSuccessMessage(`
                    <div className="mt-6 space-y-2 text-sm pb-4">
                        <p>
                            Your registration is submitted, our team will review your information and contact you with the next steps, including payment instructions and course access details.
                        </p>
                        <p>
