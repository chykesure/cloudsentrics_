...
app.post('/create-payment-intent', async (req, res) => {
    ...
    try {
        ...
        // Log values before inserting into DB
        console.log('Inserting values into DB:', {
            fullName, email, phone, country, course, paymentMethod, registrationToken, createdAt
        });
        ...
        db.query(sql, values, (err, result) => {
            ...
            transporter.sendMail(mailOptions, (error, info) => {
                if (error) {
                    ...
                    return; // Continue the flow even if email sending fails
                }
