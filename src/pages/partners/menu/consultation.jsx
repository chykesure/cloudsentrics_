            ...
            <aside className="lg:w-1/3 space-y-6">
                ...
                <div className="bg-white p-6 rounded-lg shadow-lg">
                    ...
                    <h5 className="text-xl font-bold text-gray-500">
                        We deliver strategic services that empower organizations to innovate, scale, and optimize across every layer of their IT infrastructure.
                    </h5>
                        ...
                        {[
                            ...
                            <li key={index} className="flex items-center space-x-4">
                                <div className="min-w-[32px] min-h-[32px] flex items-center justify-center">
                                    <FaArrowRight className="text-blue-600 text-3xl" />
                                </div>
