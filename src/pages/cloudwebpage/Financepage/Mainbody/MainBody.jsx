      ...
      <section className="bg-gray-50 py-16 md:py-24 lg:py-32">
        <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            {/* Left: Text content */}
            <div className="space-y-8 lg:space-y-10 max-w-lg lg:max-w-none">
              {/* Main Heading – using the exact phrasing from the image */}
              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-gray-900 tracking-tight leading-tight">
                A Secure Workspace for <span className="text-blue-900">Finance Professionals</span>
              </h2>

              {/* Descriptive text – closely follows the uploaded image wording */}
              <div className="text-lg md:text-xl text-gray-700 leading-relaxed space-y-6">
                <p>
                  Cloud Sentrics enables banks, fintechs, and financial institutions to store, manage,
                  and share sensitive financial documents and client data securely. Teams can collaborate
                  efficiently while maintaining least-privilege access to protect critical information.
                  Every action is logged for compliance, and secure sharing options such as One-Time
                  Passcodes (OTP) and expiration controls ensure confidential data is always protected.
                </p>

                <p>
                  Cloud Sentrics supports financial organizations in meeting regulatory requirements,
                  mitigating risk, and streamlining workflows all while keeping client and organizational
                  data fully under your control.
                </p>
              </div>

              {/* CTA button – prominent dark blue */}
              <div className="pt-4">
                <a
                  href="#get-quote" // ← replace with your actual link or form handler
                  className="inline-block bg-blue-900 text-white font-semibold text-lg px-12 py-5 rounded-lg shadow-lg hover:bg-blue-800 transition-colors duration-200"
                >
                  Get Quote
                </a>
              </div>
            ...
            <div className="relative">
              <img
                src="/fin1.png"           // ← make sure fin1.png is in your public folder or adjust path
                alt="Finance team collaborating securely with Cloud Sentrics"
