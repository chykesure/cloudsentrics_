      ...
      <div className="relative z-10 max-w-7xl mx-auto px-5 sm:px-6 md:px-8 lg:px-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-8 lg:gap-12">
          ...
          <div className="space-y-6 text-center md:text-left">
            ...
            <p className="text-base sm:text-lg leading-relaxed text-slate-300 max-w-xl mx-auto md:mx-0">
              We help businesses protect, manage, and deliver critical data with strong security controls, clear accountability, and compliance at the core <span className="font-bold">without relying on</span> unsecured email, shared drives or local servers.
