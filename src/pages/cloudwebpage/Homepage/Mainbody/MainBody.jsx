  ...
  return (
    <>
      ...
      <div className="relative bg-gradient-to-b from-[#0a1a3f] to-[#071029] text-white overflow-hidden">
        ...
        <section className="relative py-16 md:py-24 lg:py-32 px-4 sm:px-6 lg:px-12">
          <div className="relative z-10 max-w-7xl mx-auto">
            <div className="flex flex-col lg:grid lg:grid-cols-2 gap-10 lg:gap-12 xl:gap-20 items-center">
              {/* Image - responsive */}
              <motion.div
                ...
                className="w-full max-w-md sm:max-w-lg lg:max-w-3xl xl:max-w-4xl order-2 lg:order-1"
              >
                <div className="relative overflow-hidden rounded-2xl sm:rounded-3xl shadow-2xl shadow-cyan-900/50">
                  <img
                    src="/hmp4.png"
                    ...
                    className="
                      ...
                      shadow-inner 
                      drop-shadow-[0_20px_50px_rgba(6,182,212,0.4)] 
                      transition-all duration-500 
                      hover:scale-[1.02] hover:brightness-110
                    "
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-black/15 to-transparent pointer-events-none rounded-2xl sm:rounded-3xl" />
                </div>
              </motion.div>

              {/* Text + CTA - centered on mobile */}
              <motion.div
                initial={{ opacity: 0, x: 40 }}
                whileInView={{ opacity: 1, x: 0 }}
                viewport={{ once: true }}
                transition={{ duration: 1, delay: 0.2 }}
                className="space-y-6 sm:space-y-8 text-center lg:text-left order-1 lg:order-2 w-full"
              >
                <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold leading-tight">
                  For smaller organizations<br className="hidden lg:block" /> and private users
                </h2>

                <p className="text-base sm:text-lg md:text-xl leading-relaxed text-slate-200 max-w-3xl mx-auto lg:mx-0">
        ...
        <section className="relative py-16 md:py-24 lg:py-32 px-4 sm:px-6 lg:px-12 border-t border-cyan-900/30">
          <div className="relative z-10 max-w-7xl mx-auto">
            <div className="flex flex-col lg:grid lg:grid-cols-2 gap-10 lg:gap-12 xl:gap-20 items-center">
              {/* Text + CTA */}
              <motion.div
              ...
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ duration: 1.3 }}
                className="flex justify-center lg:justify-start order-1 lg:order-2 w-full max-w-md sm:max-w-lg lg:max-w-3xl xl:max-w-4xl"
              >
                <div className="relative overflow-hidden rounded-2xl sm:rounded-3xl shadow-2xl shadow-cyan-900/50 border border-cyan-500/20">
                  {/* Revolving light */}
                  <div
                  ...
                  <img
                    ...
                    className="
                      ...
                      rounded-2xl sm:rounded-3xl 
                      shadow-inner 
                      drop-shadow-[0_20px_50px_rgba(6,182,212,0.45)] 
                      transition-all duration-500 
                      hover:scale-[1.02] hover:brightness-110
                    "
                  />
          ...
          <div className="max-w-7xl mx-auto">
            <div className="flex flex-col lg:flex-row items-center lg:items-start justify-center gap-10 lg:gap-16">
              ...
              <motion.div
                ...
                className="w-full lg:w-1/2 max-w-3xl space-y-8 lg:space-y-12 text-center lg:text-left order-2 lg:order-1"
              >
                <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold leading-tight">
                  Build Your Future<br className="hidden lg:block" /> with Cloud Sentrics
                </h2>

                <p className="text-base sm:text-lg md:text-xl leading-relaxed text-gray-700 max-w-3xl mx-auto lg:mx-0">
              ...
              <motion.div
                ...
                className="w-full lg:w-1/2 max-w-lg lg:max-w-2xl flex justify-center lg:justify-start order-1 lg:order-2"
              >
