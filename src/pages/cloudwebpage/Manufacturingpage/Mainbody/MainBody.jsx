      ...
      <section className="bg-gray-50 py-16 md:py-24 lg:py-32">
        <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
          ...
          <div className="text-center">
            {/* Main Heading */}
            <h2 className="text-3xl sm:text-4xl lg:text-6xl font-extrabold text-gray-900 tracking-tight leading-tight mb-8 md:mb-12">
              Driving Digital Transformation and<br className="hidden sm:inline" />
              Cloud Security in Manufacturing
            </h2>

            {/* Challenge / Problem paragraphs – first block of text */}
            <div className="max-w-4xl mx-auto text-lg md:text-xl text-gray-700 leading-relaxed mb-12 md:mb-16">
              <p className="mb-6">
                Evolving data protection regulations, a mobile workforce, and collaboration with global partners demand a strong and reliable cloud security strategy. Engineering and manufacturing companies are undergoing rapid digital transformation, increasing the need for secure, scalable, and future-ready data infrastructure.

                As one of the world’s most traditional industries, manufacturing is experiencing significant IT change. The growing use of digital tools, automation, and data-driven processes has made secure data storage, protection, and collaboration more critical than ever.
              </p>
            </div>

            {/* Prominent Hero Image – placed here, after intro text, like your example */}
            <div className="mb-12 md:mb-16 -mx-4 sm:-mx-6 lg:-mx-8 overflow-hidden rounded-2xl shadow-2xl">
              <img
                src="/man1.png"
                alt="Manufacturing engineers collaborating on digital engine model with AR overlay in high-tech workshop"
                className="w-full h-auto object-cover"
              />
            </div>

            {/* Solution paragraphs – second block of text */}
            <div className="max-w-4xl mx-auto text-lg md:text-xl text-gray-700 leading-relaxed">
              <p className="mb-6">
                Cloud Sentrics provides a secure digital workspace designed for engineering and manufacturing environments. With secure cloud storage, data protection, controlled file sharing, and content collaboration, Cloud Sentrics enables organizations to work efficiently while keeping sensitive designs, production data, and intellectual property fully protected. Our platform delivers the flexibility, scalability, and security industrial companies need while ensuring complete data control and compliance.
              </p>
            </div>
          </div>
        </div>
