                ...
                <div className="bg-slate-50 p-6 rounded-2xl border border-slate-100">
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center text-slate-600">
                      ...
                      <a href="mailto:info@cloudsentrics.org" className="hover:text-blue-600 transition-colors cursor-pointer">
                    ...
                    <div className="flex items-center text-slate-600">
                      ...
                      <a href="tel:+2348144573546" className="hover:text-blue-600 transition-colors cursor-pointer">
                        +234 814 457 3546
                      </a>
                    </div>
                  </div>
