    ...
    transition-all duration-300 transform hover:bg-[#18365a] hover:scale-105 shadow-lg animate-bounce">
            ...
            <section className="bg-gray-100 py-16 px-6 sm:px-10 lg:px-20">
                ...
                <div className="grid grid-cols-1 md:grid-cols-5 gap-10 items-stretch">
                    {/* Left Side - Image */}
                    <div className="md:col-span-3 rounded-lg overflow-hidden shadow-lg w-full">
                    <img
                    ...
                    <div className="md:col-span-2 bg-white p-8 shadow-lg rounded-xl h-full flex flex-col justify-between">
                        <div>
